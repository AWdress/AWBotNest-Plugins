...
| auto_lottery | Interactive | 中 | 否 | 否 | 是 | 是 | Telegram | Vue | 已完成 |
...
| awrelay | Automation | 高 | 否 | 否 | 是 | 是 | Telegram Forum | Vue | 已完成 |
...
| digital_pet | Interactive | 中 | 否 | 否 | 是 | 是 | Telegram | 否 | 已完成 |
| dyp_redpacket | Interactive | 中 | 否 | 否 | 否 | 是 | Telegram | 否 | 已完成 |
| emby_toolbox | External | 高 | 否 | 否 | 是 | 是 | Emby | Vue | 已完成 |
...
| hhan_lottery | Interactive/External | 极高 | 否 | 否 | 是 | 是 | HTTP | Vue | 已完成 |
| human_lottery | Interactive | 高 | 否 | 否 | 是 | 是 | Telegram | Vue | 已完成 |
| id | Utility | 低 | 否 | 否 | 否 | 否 | Telegram | Schema | 已完成 |
| jupai | Interactive | 低 | 否 | 否 | 是 | 否 | HTTP/Telegram | 否 | 已完成 |
| keyword_auto_reply | Automation | 中 | 否 | 否 | 是 | 是 | Telegram | Vue | 已完成 |
...
| quiz_game | Interactive | 高 | 否 | 否 | 是 | 是 | HTTP/AI | Vue | 已完成 |
| red_packet_grab | Interactive | 高 | 否 | 否 | 是 | 否 | Telegram/OCR | Vue | 已完成 |
| red_packet_send | Interactive | 高 | 否 | 否 | 是 | 是 | Telegram | Vue | 已完成 |
| self_delete | Utility | 低 | 否 | 否 | 否 | 否 | Telegram | Schema | 已完成 |
| trans115search | Automation | 中 | 否 | 否 | 是 | 否 | Telegram | Schema | 已完成 |
| transfer | Automation | 高 | 否 | 否 | 是 | 是 | Telegram | Vue | 已完成 |
...
| zhuque_lottery | Interactive/External | 极高 | 否 | 否 | 是 | 是 | HTTP | Vue | 已完成 |
