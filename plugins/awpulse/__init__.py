...
DEFAULTS = {
    ...
    "skip_keywords": [
        "公告", "通知", "规则", "版规", "置顶", "热门", "2024年永久访问本站方法",
        "APP下载", "白名单", "邀请码", "访问方法", "屏蔽", "封禁", "违规", "删除",
        "警告", "发布器", "最新方法", "申诉", "二次验证", "禁止申诉", "高薪", "招聘",
    ],
