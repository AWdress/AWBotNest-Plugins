...
const _hoisted_8 = { class: "row row-top" };
...
const _hoisted_13 = { class: "range-control" };
const _hoisted_14 = {
  key: 1,
  class: "tip indent-tip"
};
const _hoisted_15 = {
  key: 1,
  class: "row"
...
const _hoisted_20 = { class: "row indent" };
...
const _hoisted_29 = { class: "tbl" };
const _hoisted_30 = { class: "muted" };
const _hoisted_31 = { class: "gold" };
    ...
    _createElementVNode("div", _hoisted_3, [
      (tab.value === 'settings')
        ? (_openBlock(), _createElementBlock("div", _hoisted_4, [
            _cache[36] || (_cache[36] = _createStaticVNode("<section class=\"section command-guide\" aria-labelledby=\"command-guide-title\" data-v-05e3d5d3><div class=\"guide-heading\" data-v-05e3d5d3><div data-v-05e3d5d3><h3 id=\"command-guide-title\" data-v-05e3d5d3>命令与玩法</h3><p data-v-05e3d5d3>命令仅由插件绑定的本人账号发送，群友只需直接发送答案。</p></div><span class=\"guide-badge\" data-v-05e3d5d3>本人命令</span></div><div class=\"command-list\" data-v-05e3d5d3><div class=\"command-item\" data-v-05e3d5d3><code data-v-05e3d5d3>开启答题</code><span data-v-05e3d5d3>按下方设置的题目数量生成题目并开始，也支持“开始答题”。</span></div><div class=\"command-item\" data-v-05e3d5d3><code data-v-05e3d5d3>结束答题</code><span data-v-05e3d5d3>立即结束本场，并清理题目、奖励等答题消息。</span></div></div><p class=\"guide-note\" data-v-05e3d5d3>最先答对的群友获奖，答错会收到短暂提示；单题超时会公布答案并继续下一题。完成全部题目或由本人发送结束命令后，系统会清理本场消息。</p></section>", 1)),
            _createElementVNode("div", _hoisted_5, [
              _cache[18] || (_cache[18] = _createElementVNode("h3", null, "群组设置", -1)),
              _createElementVNode("label", _hoisted_6, [
                _cache[15] || (_cache[15] = _createElementVNode("span", null, "允许的群组", -1)),
              ...
              (chatNames.value.length)
                ? (_openBlock(), _createElementBlock("div", _hoisted_7, [
                    _cache[16] || (_cache[16] = _createElementVNode("span", { class: "chat-label" }, "已识别：", -1)),
              ...
              _createElementVNode("label", _hoisted_8, [
                _cache[17] || (_cache[17] = _createElementVNode("span", null, "答题黑名单", -1)),
                _withDirectives(_createElementVNode("textarea", {
                  "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => ((cfg.value.blacklist_users) = $event)),
                  class: "inp textarea",
                  rows: "4",
                  placeholder: "用户 ID 或 @username，支持逗号或换行分隔"
                }, null, 512), [
                  [_vModelText, cfg.value.blacklist_users]
                ])
              ]),
              _cache[19] || (_cache[19] = _createElementVNode("p", { class: "tip" }, "黑名单用户的答案将被静默忽略，不提示、不计分，也不会发放奖励。", -1))
            ]),
            _createElementVNode("div", _hoisted_9, [
              _cache[26] || (_cache[26] = _createElementVNode("h3", null, "出题源", -1)),
              _createElementVNode("label", _hoisted_10, [
                _cache[21] || (_cache[21] = _createElementVNode("span", null, "出题方式", -1)),
                _withDirectives(_createElementVNode("select", {
                  "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((cfg.value.source) = $event)),
                  class: "inp"
                }, [...(_cache[20] || (_cache[20] = [
              ...
              (cfg.value.source === 'ai')
                ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                    _cache[24] || (_cache[24] = _createElementVNode("p", { class: "tip" }, "使用平台统一 AI 服务（在「系统设置→AI 服务」配置）。", -1)),
                    _createElementVNode("label", _hoisted_11, [
                      _withDirectives(_createElementVNode("input", {
                        "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((cfg.value.ai_image_enabled) = $event)),
                        type: "checkbox"
                      }, null, 512), [
                        [_vModelCheckbox, cfg.value.ai_image_enabled]
                      ]),
                      _cache[22] || (_cache[22] = _createElementVNode("span", null, "启用 AI 图文题", -1))
                    ]),
                    (cfg.value.ai_image_enabled)
                      ? (_openBlock(), _createElementBlock("label", _hoisted_12, [
                          _cache[23] || (_cache[23] = _createElementVNode("span", null, "配图题比例", -1)),
                          _createElementVNode("div", _hoisted_13, [
                            _withDirectives(_createElementVNode("input", {
                              "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((cfg.value.ai_image_ratio) = $event)),
                              type: "range",
                              min: "0",
                              max: "100",
                              step: "10"
                              ...
                              [
                                _vModelText,
                                cfg.value.ai_image_ratio,
                                void 0,
                                { number: true }
                              ]
                            ]),
                            _createElementVNode("output", null, _toDisplayString(cfg.value.ai_image_ratio) + "%", 1)
                          ])
                        ]))
                      : _createCommentVNode("", true),
                    (cfg.value.ai_image_enabled)
                      ? (_openBlock(), _createElementBlock("p", _hoisted_14, "仅为部分题目生成无文字配图；平台生图不可用或生成失败时自动使用纯文字题。"))
                      : _createCommentVNode("", true)
                  ], 64))
                : _createCommentVNode("", true),
              (cfg.value.source === 'tianapi')
                ? (_openBlock(), _createElementBlock("label", _hoisted_15, [
                    _cache[25] || (_cache[25] = _createElementVNode("span", null, "天行数据 Key", -1)),
                    _withDirectives(_createElementVNode("input", {
            ...
            _createElementVNode("div", _hoisted_16, [
              _cache[31] || (_cache[31] = _createElementVNode("h3", null, "奖励设置", -1)),
              _createElementVNode("label", _hoisted_17, [
                _cache[27] || (_cache[27] = _createElementVNode("span", null, "基础奖励(魔力)", -1)),
                _withDirectives(_createElementVNode("input", {
              ...
              _createElementVNode("label", _hoisted_18, [
                ...
                _cache[28] || (_cache[28] = _createElementVNode("span", null, "启用连胜加成", -1))
              ]),
              (cfg.value.streak_enabled)
                ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                    _createElementVNode("label", _hoisted_19, [
                      _cache[29] || (_cache[29] = _createElementVNode("span", null, "连胜倍率", -1)),
                      _withDirectives(_createElementVNode("input", {
                    ...
                    _createElementVNode("label", _hoisted_20, [
                      _cache[30] || (_cache[30] = _createElementVNode("span", null, "最大连胜", -1)),
                      _withDirectives(_createElementVNode("input", {
            ...
            _createElementVNode("div", _hoisted_21, [
              _cache[35] || (_cache[35] = _createElementVNode("h3", null, "答题规则", -1)),
              _createElementVNode("label", _hoisted_22, [
                _cache[32] || (_cache[32] = _createElementVNode("span", null, "每场题目数量", -1)),
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((cfg.value.question_count) = $event)),
                  type: "number",
                  class: "inp",
                  min: "1",
                  max: "20"
              ...
              _createElementVNode("label", _hoisted_23, [
                _cache[33] || (_cache[33] = _createElementVNode("span", null, "答题超时(秒)", -1)),
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((cfg.value.timeout) = $event)),
                  type: "number",
                  class: "inp",
                  min: "10"
                }, null, 512), [
              ...
              _createElementVNode("label", _hoisted_24, [
                _cache[34] || (_cache[34] = _createElementVNode("span", null, "自动删除延迟(秒)", -1)),
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((cfg.value.auto_delete_delay) = $event)),
                  type: "number",
                  class: "inp",
                  min: "0"
                }, null, 512), [
        ...
        : (_openBlock(), _createElementBlock("div", _hoisted_26, [
            _createElementVNode("div", _hoisted_27, [
              ...
              _createElementVNode("span", _hoisted_28, "最近 " + _toDisplayString(history.value.length) + " 条", 1)
            ]),
              ...
              _createElementVNode("tbody", null, [
                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(history.value, (h, i) => {
                  return (_openBlock(), _createElementBlock("tr", { key: i }, [
                    _createElementVNode("td", _hoisted_30, _toDisplayString(h.time), 1),
                    ...
                    _createElementVNode("td", _hoisted_31, _toDisplayString(h.reward || 0), 1)
                  ]))
                }), 128)),
                (!history.value.length)
                  ? (_openBlock(), _createElementBlock("tr", _hoisted_32, [...(_cache[37] || (_cache[37] = [
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-05e3d5d3"]]);
