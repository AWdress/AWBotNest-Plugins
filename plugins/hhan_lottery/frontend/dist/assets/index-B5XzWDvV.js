...
import Config from './__federation_expose_Config-CDlaMeH8.js';
...
let config = { cookie_source: 'platform', manual_cookie: '', enabled: true, bonus_enabled: true, auto_confirm_bonus_transfer: false, auto_grab_random_packet: false, random_packet_delay_min: 1, random_packet_delay_max: 5, notify_result: true, notify_cookie_error: true, single_command: '.hh', batch_command: '.hhs', cooldown_seconds: 10, result_delete: 90, lottery_mode: 'fixed', lottery_count: 10, interval_seconds: 7, reserve_beans: 0, sync_every_draws: 20, auto_clean_lottery_mail: false, stop_on_prize: false, stop_on_vip: true, stop_on_invite: true, stop_on_big_beans: true, big_bean_threshold: 500000, stop_prize_keywords: '', scheduled_stop_enabled: false, scheduled_stop_at: '', page_delay: 1, max_pages: 200 };
let running = false;
let processed = 0;
