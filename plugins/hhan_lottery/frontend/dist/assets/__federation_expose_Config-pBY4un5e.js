...
const {createElementVNode:_createElementVNode$3,toDisplayString:_toDisplayString$2,createTextVNode:_createTextVNode$2,normalizeClass:_normalizeClass$3,normalizeStyle:_normalizeStyle$1,vModelCheckbox:_vModelCheckbox$2,withDirectives:_withDirectives$2,vModelText:_vModelText$2,openBlock:_openBlock$3,createElementBlock:_createElementBlock$3} = await importShared('vue');


const _hoisted_1$3 = { class: "panel" };
const _hoisted_2$3 = { class: "progress-card" };
const _hoisted_3$2 = { class: "progress-top" };
const _hoisted_4$2 = { class: "track" };
const _hoisted_5$2 = { class: "grid" };
const _hoisted_6$2 = { class: "card settings" };
const _hoisted_7$2 = { class: "toggle-row" };
const _hoisted_8$2 = ["max"];
...
const {computed: computed$1,onBeforeUnmount: onBeforeUnmount$1,onMounted: onMounted$2,reactive: reactive$2,ref: ref$3} = await importShared('vue');
...
const props = __props;
const cfg = reactive$2({ enabled: true, notify_result: true, notify_cookie_error: true, lottery_count: 10, max_count: 100, interval_seconds: 7 });
const status = ref$3({ running: false, completed: 0, target: 0, detail: '', last_prize: '', last_result: '' });
const stats = ref$3('暂无累计统计');
const busy = ref$3('');
let timer;

const progress = computed$1(() => status.value.target ? Math.min(100, Math.round(status.value.completed / status.value.target * 100)) : 0);
const stateText = computed$1(() => status.value.running ? `正在抽奖 ${status.value.completed}/${status.value.target}` : (status.value.detail || '等待开始'));
...
return (_ctx, _cache) => {
  return (_openBlock$3(), _createElementBlock$3("section", _hoisted_1$3, [
    _createElementVNode$3("header", null, [
      _cache[10] || (_cache[10] = _createElementVNode$3("div", null, [
        _createElementVNode$3("p", { class: "eyebrow" }, "HHANCLUB"),
        _createElementVNode$3("h2", null, "幸运转盘"),
        _createElementVNode$3("p", { class: "sub" }, "使用平台已登录 Cookie，在后台按设定次数抽奖。")
      ], -1)),
      _createElementVNode$3("span", {
        class: _normalizeClass$3(["state", { live: status.value.running }])
      }, [
        _cache[9] || (_cache[9] = _createElementVNode$3("i", null, null, -1)),
        _createTextVNode$2(_toDisplayString$2(stateText.value), 1)
      ], 2)
    ]),
    _createElementVNode$3("div", _hoisted_2$3, [
      _createElementVNode$3("div", _hoisted_3$2, [
        _createElementVNode$3("strong", null, [
          _createTextVNode$2(_toDisplayString$2(status.value.completed) + " ", 1),
          _createElementVNode$3("small", null, "/ " + _toDisplayString$2(status.value.target || cfg.lottery_count) + " 次", 1)
        ]),
        _createElementVNode$3("span", null, _toDisplayString$2(progress.value) + "%", 1)
      ]),
      ...
      _createElementVNode$3("p", null, _toDisplayString$2(status.value.last_prize ? `最近奖品：${status.value.last_prize}` : '开始后这里会实时显示进度与最近奖品。'), 1)
    ]),
    _createElementVNode$3("div", _hoisted_5$2, [
      _createElementVNode$3("div", _hoisted_6$2, [
        _cache[16] || (_cache[16] = _createElementVNode$3("h3", null, "抽奖设置", -1)),
        _createElementVNode$3("label", _hoisted_7$2, [
          _cache[11] || (_cache[11] = _createElementVNode$3("span", null, [
            _createElementVNode$3("b", null, "启用转盘"),
        ...
        _createElementVNode$3("label", null, [
          _cache[12] || (_cache[12] = _createElementVNode$3("span", null, "抽奖次数", -1)),
          _withDirectives$2(_createElementVNode$3("input", {
        ...
        _createElementVNode$3("label", null, [
          _cache[13] || (_cache[13] = _createElementVNode$3("span", null, "抽奖间隔（秒）", -1)),
          _withDirectives$2(_createElementVNode$3("input", {
        ...
        _createElementVNode$3("label", _hoisted_9$2, [
          _withDirectives$2(_createElementVNode$3("input", {
        ...
        _createElementVNode$3("label", _hoisted_10$2, [
          _withDirectives$2(_createElementVNode$3("input", {
      ...
      _createElementVNode$3("div", _hoisted_12$2, [
        _cache[17] || (_cache[17] = _createElementVNode$3("h3", null, "最近结果", -1)),
        _createElementVNode$3("pre", null, _toDisplayString$2(status.value.last_result || '还没有抽奖记录。'), 1),
        _cache[18] || (_cache[18] = _createElementVNode$3("h3", null, "累计统计", -1)),
        _createElementVNode$3("pre", null, _toDisplayString$2(stats.value), 1)
      ])
    ]),
    _createElementVNode$3("footer", null, [
      _createElementVNode$3("button", {
        class: "primary",
        disabled: busy.value || status.value.running || !cfg.enabled,
        onClick: _cache[6] || (_cache[6] = $event => (action('run', '/lottery/run')))
      }, _toDisplayString$2(busy.value === 'run' ? '正在启动…' : '开始抽奖'), 9, _hoisted_13$2),
      _createElementVNode$3("button", {
        class: "danger",
...
const LotteryPanel = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-0ffce8ff"]]);

const {createElementVNode:_createElementVNode$2,openBlock:_openBlock$2,createElementBlock:_createElementBlock$2,createCommentVNode:_createCommentVNode$2,toDisplayString:_toDisplayString$1,createTextVNode:_createTextVNode$1,normalizeClass:_normalizeClass$2,Fragment:_Fragment$1,normalizeStyle:_normalizeStyle,vModelCheckbox:_vModelCheckbox$1,withDirectives:_withDirectives$1,vModelText:_vModelText$1,renderList:_renderList} = await importShared('vue');


const _hoisted_1$2 = { class: "read-panel" };
const _hoisted_2$2 = {
  key: 0,
  class: "skeleton",
  "aria-label": "正在加载"
...
const _hoisted_4$1 = { class: "title-wrap" };
const _hoisted_5$1 = ["innerHTML"];
const _hoisted_6$1 = {
  class: "run-area",
  "aria-labelledby": "run-heading"
};
const _hoisted_7$1 = { class: "run-copy" };
const _hoisted_8$1 = { class: "meta" };
const _hoisted_9$1 = { class: "actions" };
...
const {computed,onBeforeUnmount,onMounted: onMounted$1,reactive: reactive$1,ref: ref$2} = await importShared('vue');
...
const cfg = reactive$1({ enabled: true, notify_result: true, page_delay: 1, max_pages: 200 });
const status = ref$2({
...
const starting = ref$2(false);
const deleting = ref$2(false);
const stopping = ref$2(false);
...
return (_ctx, _cache) => {
  return (_openBlock$2(), _createElementBlock$2("div", _hoisted_1$2, [
    (loading.value)
      ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_2$2, [...(_cache[4] || (_cache[4] = [
          _createElementVNode$2("span", null, null, -1),
          _createElementVNode$2("span", null, null, -1),
          _createElementVNode$2("span", null, null, -1)
        ]))]))
      : (_openBlock$2(), _createElementBlock$2(_Fragment$1, { key: 1 }, [
          _createElementVNode$2("header", _hoisted_3$1, [
            _createElementVNode$2("div", _hoisted_4$1, [
              ...
              _cache[5] || (_cache[5] = _createElementVNode$2("div", null, [
                _createElementVNode$2("h2", null, "消息管理"),
                _createElementVNode$2("p", null, "可以将未读消息批量设为已读，或删除收件箱全部消息。")
              ], -1))
            ]),
            _createElementVNode$2("span", {
              class: _normalizeClass$2(["state", statusTone.value])
            }, [
              _cache[6] || (_cache[6] = _createElementVNode$2("i", null, null, -1)),
              _createTextVNode$1(_toDisplayString$1(phaseLabel.value), 1)
            ], 2)
          ]),
          _createElementVNode$2("section", _hoisted_6$1, [
            _createElementVNode$2("div", _hoisted_7$1, [
              _cache[7] || (_cache[7] = _createElementVNode$2("span", {
                id: "run-heading",
                class: "section-label"
              }, "当前任务", -1)),
              _createElementVNode$2("strong", null, _toDisplayString$1(status.value.message), 1),
              _createElementVNode$2("span", _hoisted_8$1, [
                (status.value.total_pages)
                  ? (_openBlock$2(), _createElementBlock$2(_Fragment$1, { key: 0 }, [
                      _createTextVNode$1("第 " + _toDisplayString$1(status.value.current_page) + "/" + _toDisplayString$1(status.value.total_pages) + " 页 · ", 1)
                    ], 64))
                  : _createCommentVNode$2("", true),
                _createTextVNode$1(" 已处理 " + _toDisplayString$1(status.value.processed) + " 条 ", 1)
              ])
            ]),
            _createElementVNode$2("div", _hoisted_9$1, [
              (!status.value.running)
                ? (_openBlock$2(), _createElementBlock$2("button", {
                    ...
                    _createTextVNode$1(" " + _toDisplayString$1(starting.value ? '启动中…' : '开始全部已读'), 1)
                  ], 8, _hoisted_10$1))
                : _createCommentVNode$2("", true),
              (!status.value.running)
                ? (_openBlock$2(), _createElementBlock$2("button", {
                    ...
                    _createTextVNode$1(" " + _toDisplayString$1(deleting.value ? '启动中…' : '删除全部消息'), 1)
                  ], 8, _hoisted_12$1))
                : (_openBlock$2(), _createElementBlock$2("button", {
                    key: 2,
                    class: "button danger",
                    ...
                    _createTextVNode$1(" " + _toDisplayString$1(status.value.stop_requested ? '等待停止…' : stopping.value ? '提交中…' : '停止任务'), 1)
                  ], 8, _hoisted_14)),
              _createElementVNode$2("button", {
                ...
                _createTextVNode$1(" " + _toDisplayString$1(checking.value ? '检查中…' : '检查 Cookie'), 1)
              ], 8, _hoisted_16)
            ]),
          ...
          _createElementVNode$2("div", _hoisted_19, [
            _createElementVNode$2("section", _hoisted_20, [
              _createElementVNode$2("div", _hoisted_21, [
                _cache[8] || (_cache[8] = _createElementVNode$2("div", null, [
                  _createElementVNode$2("h3", { id: "settings-heading" }, "运行设置"),
                  _createElementVNode$2("p", null, "开始任务时会先自动保存这些设置。")
                ], -1)),
                _createElementVNode$2("button", {
                  class: "button compact",
                  disabled: saving.value,
                  onClick: save
                }, _toDisplayString$1(saving.value ? '保存中…' : '保存'), 9, _hoisted_22)
              ]),
              _createElementVNode$2("label", _hoisted_23, [
                _cache[9] || (_cache[9] = _createElementVNode$2("span", null, [
                  _createElementVNode$2("b", null, "启用插件"),
                  _createElementVNode$2("small", null, "关闭后不能启动新任务")
                ], -1)),
              ...
              _createElementVNode$2("label", _hoisted_24, [
                _cache[10] || (_cache[10] = _createElementVNode$2("span", null, [
                  _createElementVNode$2("b", null, "完成后推送结果"),
                  _createElementVNode$2("small", null, "通过平台通知渠道发送处理汇总")
                ], -1)),
                _withDirectives$1(_createElementVNode$2("input", {
              ...
              _createElementVNode$2("div", _hoisted_25, [
                _createElementVNode$2("label", null, [
                  _cache[12] || (_cache[12] = _createElementVNode$2("span", null, "翻页间隔", -1)),
                  _createElementVNode$2("div", _hoisted_26, [
                    _withDirectives$1(_createElementVNode$2("input", {
                    ...
                    _cache[11] || (_cache[11] = _createElementVNode$2("em", null, "秒", -1))
                  ])
                ]),
                _createElementVNode$2("label", null, [
                  _cache[14] || (_cache[14] = _createElementVNode$2("span", null, "最多扫描", -1)),
                  _createElementVNode$2("div", _hoisted_27, [
                    _withDirectives$1(_createElementVNode$2("input", {
                    ...
                    _cache[13] || (_cache[13] = _createElementVNode$2("em", null, "页", -1))
                  ])
                ])
              ]),
              _cache[15] || (_cache[15] = _createElementVNode$2("p", { class: "notice" }, [
                _createElementVNode$2("b", null, "全部已读"),
                _createTextVNode$1("只处理带 "),
                _createElementVNode$2("code", null, "icon-unread.svg"),
                _createTextVNode$1(" 标记的消息；"),
                _createElementVNode$2("b", null, "删除全部消息"),
                _createTextVNode$1("会清空当前收件箱中的已读和未读消息，且无法撤销。")
              ], -1))
            ]),
            _createElementVNode$2("section", _hoisted_28, [
              _createElementVNode$2("div", _hoisted_29, [
                _cache[16] || (_cache[16] = _createElementVNode$2("div", null, [
                  _createElementVNode$2("h3", { id: "history-heading" }, "最近运行"),
                  _createElementVNode$2("p", null, "保留最近 20 次处理结果。")
                ], -1)),
                _createElementVNode$2("div", _hoisted_30, [
                  _createElementVNode$2("button", {
                    class: "icon-button",
                    title: "刷新记录",
                    "aria-label": "刷新记录",
              ...
              (!history.value.length)
                ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_34, [
                    (_openBlock$2(), _createElementBlock$2("svg", {
                      viewBox: "0 0 24 24",
                      "aria-hidden": "true",
                      innerHTML: iconPath('inbox')
                    }, null, 8, _hoisted_35)),
                    _cache[17] || (_cache[17] = _createElementVNode$2("b", null, "还没有运行记录", -1)),
                    _cache[18] || (_cache[18] = _createElementVNode$2("span", null, "首次执行后，处理数量和结果会显示在这里。", -1))
                  ]))
                : (_openBlock$2(), _createElementBlock$2("div", _hoisted_36, [
                    (_openBlock$2(true), _createElementBlock$2(_Fragment$1, null, _renderList(history.value, (item, index) => {
                      return (_openBlock$2(), _createElementBlock$2("article", {
                        key: item.time + index,
                        class: "history-item"
                      }, [
                        _createElementVNode$2("span", {
                          class: _normalizeClass$2(["history-status", item.status])
                        }, _toDisplayString$1(historyStatus(item)), 3),
                        _createElementVNode$2("div", null, [
                          _createElementVNode$2("b", null, _toDisplayString$1(operationLabel(item)) + " · " + _toDisplayString$1(item.processed) + " 条消息", 1),
                          _createElementVNode$2("span", null, _toDisplayString$1(item.detail), 1)
                        ]),
                        _createElementVNode$2("div", _hoisted_37, [
                          _createElementVNode$2("time", null, _toDisplayString$1(item.time), 1),
                          _createElementVNode$2("span", null, _toDisplayString$1(item.pages) + " 页", 1)
                        ])
                      ]))
                    }), 128))
                  ]))
...
const ReadPanel = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-cda4d93d"]]);

const {openBlock:_openBlock$1,createElementBlock:_createElementBlock$1,createCommentVNode:_createCommentVNode$1,createElementVNode:_createElementVNode$1,toDisplayString:_toDisplayString,createTextVNode:_createTextVNode,normalizeClass:_normalizeClass$1,vModelCheckbox:_vModelCheckbox,withDirectives:_withDirectives,vModelText:_vModelText,Fragment:_Fragment} = await importShared('vue');


const _hoisted_1$1 = { class: "bonus-panel" };
const _hoisted_2$1 = {
  key: 0,
  class: "loading"
};
...
const _hoisted_8 = { class: "switch-row" };
...
const {onMounted,reactive,ref: ref$1} = await importShared('vue');
...
return (_ctx, _cache) => {
  return (_openBlock$1(), _createElementBlock$1("section", _hoisted_1$1, [
    (loading.value)
      ? (_openBlock$1(), _createElementBlock$1("div", _hoisted_2$1, "正在读取配置…"))
      : (_openBlock$1(), _createElementBlock$1(_Fragment, { key: 1 }, [
          _createElementVNode$1("header", null, [
            _cache[7] || (_cache[7] = _createElementVNode$1("div", null, [
              _createElementVNode$1("p", { class: "eyebrow" }, "HHANCLUB"),
              _createElementVNode$1("h2", null, "赠豆助手"),
              _createElementVNode$1("p", null, "通过自己的用户账号发送命令，支持单人和批量赠送。")
            ], -1)),
            _createElementVNode$1("span", {
              class: _normalizeClass$1(["badge", { on: cfg.bonus_enabled }])
            }, [
              _cache[6] || (_cache[6] = _createElementVNode$1("i", null, null, -1)),
              _createTextVNode(_toDisplayString(cfg.bonus_enabled ? '命令已启用' : '命令已停用'), 1)
            ], 2)
          ]),
          _createElementVNode$1("div", _hoisted_3, [
            _createElementVNode$1("section", _hoisted_4, [
              _createElementVNode$1("div", _hoisted_5, [
                _cache[8] || (_cache[8] = _createElementVNode$1("div", null, [
                  _createElementVNode$1("h3", null, "命令设置"),
                  _createElementVNode$1("p", null, "修改后立即保存，下一条消息开始生效。")
                ], -1)),
                _createElementVNode$1("button", {
                  class: "primary",
                  disabled: saving.value,
                  onClick: save
                }, _toDisplayString(saving.value ? '保存中…' : '保存设置'), 9, _hoisted_6)
              ]),
              _createElementVNode$1("label", _hoisted_7, [
                _cache[9] || (_cache[9] = _createElementVNode$1("span", null, [
                  _createElementVNode$1("b", null, "启用赠豆命令"),
                  _createElementVNode$1("small", null, "监听用户账号发出的匹配命令")
                ], -1)),
              ...
              _createElementVNode$1("label", _hoisted_8, [
                _cache[10] || (_cache[10] = _createElementVNode$1("span", null, [
                  _createElementVNode$1("b", null, "Cookie 异常时通知"),
                  _createElementVNode$1("small", null, "登录态失效时通过平台通知提醒")
                ], -1)),
                _withDirectives(_createElementVNode$1("input", {
              ...
              _createElementVNode$1("div", _hoisted_9, [
                _createElementVNode$1("label", null, [
                  _cache[11] || (_cache[11] = _createElementVNode$1("span", null, "单人命令", -1)),
                  _withDirectives(_createElementVNode$1("input", {
                ...
                _createElementVNode$1("label", null, [
                  _cache[12] || (_cache[12] = _createElementVNode$1("span", null, "批量命令", -1)),
                  _withDirectives(_createElementVNode$1("input", {
                ...
                _createElementVNode$1("label", null, [
                  _cache[14] || (_cache[14] = _createElementVNode$1("span", null, "赠送冷却", -1)),
                  _createElementVNode$1("div", null, [
                    ...
                    _cache[13] || (_cache[13] = _createElementVNode$1("em", null, "秒", -1))
                  ])
                ]),
                _createElementVNode$1("label", null, [
                  _cache[16] || (_cache[16] = _createElementVNode$1("span", null, "结果保留", -1)),
                  _createElementVNode$1("div", null, [
                    _withDirectives(_createElementVNode$1("input", {
                    ...
                    _cache[15] || (_cache[15] = _createElementVNode$1("em", null, "秒", -1))
                  ])
                ])
              ])
            ]),
            _createElementVNode$1("aside", _hoisted_10, [
              _cache[19] || (_cache[19] = _createElementVNode$1("h3", null, "命令格式", -1)),
              _createElementVNode$1("div", _hoisted_11, [
                _cache[17] || (_cache[17] = _createElementVNode$1("span", null, "单人赠送", -1)),
                _createElementVNode$1("code", null, _toDisplayString(cfg.single_command || '.hh') + " Alice 100 感谢分享", 1)
              ]),
              _createElementVNode$1("div", _hoisted_12, [
                _cache[18] || (_cache[18] = _createElementVNode$1("span", null, "批量赠送", -1)),
                _createElementVNode$1("code", null, _toDisplayString(cfg.batch_command || '.hhs') + " Alice Bob 100 感谢", 1)
              ]),
              _cache[20] || (_cache[20] = _createElementVNode$1("ul", null, [
                _createElementVNode$1("li", null, "站点最低赠送 100 憨豆"),
                _createElementVNode$1("li", null, "批量任务最多 50 位用户"),
                _createElementVNode$1("li", null, "接收方会按站点规则扣除税费"),
                _createElementVNode$1("li", null, "批量留言不能包含空格")
              ], -1)),
              _createElementVNode$1("button", {
                class: "secondary",
                disabled: checking.value,
                onClick: checkCookie
              }, _toDisplayString(checking.value ? '检查中…' : '检查平台 Cookie'), 9, _hoisted_13)
            ])
          ])
        ], 64))
  ]))
...
const BonusPanel = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-db48bb98"]]);
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-5b8cdba6"]]);
