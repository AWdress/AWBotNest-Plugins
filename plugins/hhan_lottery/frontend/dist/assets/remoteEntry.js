const currentImports = {};
      ...
      let moduleMap = {
"./Config":()=>{
      dynamicLoadingCss(["__federation_expose_Config-DDoxK_Gz.css"], false, './Config');
      return __federation_import('/api/plugins/hhan_lottery/fe/assets/__federation_expose_Config-Ccq1y7fp.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
