            ...
            _createElementVNode("div", _hoisted_8, [
              (group.value === 'image')
                ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                    _cache[26] || (_cache[26] = _createElementVNode("h3", { class: "det-title" }, "AI 生图", -1)),
                    _createElementVNode("section", _hoisted_9, [
                      _createElementVNode("label", _hoisted_10, [
                        _withDirectives(_createElementVNode("input", {
                          "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => ((cfg.enable_image_generation) = $event)),
                          type: "checkbox"
                        }, null, 512), [
                          [_vModelCheckbox, cfg.enable_image_generation]
                        ]),
                        _cache[19] || (_cache[19] = _createElementVNode("span", null, "启用 AI 生图命令", -1))
                      ]),
                      _cache[25] || (_cache[25] = _createElementVNode("p", { class: "tip" }, "发送 /生图 画面描述 或 /draw prompt，生成后会直接把图片发到当前会话（使用平台统一 AI 服务）。", -1)),
                      (cfg.enable_image_generation)
                        ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                            _createElementVNode("div", _hoisted_11, [
                              _createElementVNode("label", _hoisted_12, [
                                _cache[21] || (_cache[21] = _createElementVNode("span", null, "图片尺寸", -1)),
                              ...
                              _createElementVNode("label", _hoisted_13, [
                                _cache[23] || (_cache[23] = _createElementVNode("span", null, "生成质量", -1)),
                                _withDirectives(_createElementVNode("select", {
                            ...
                            _cache[24] || (_cache[24] = _createElementVNode("p", { class: "tip" }, "不同模型支持的尺寸和质量可能不同；不确定时质量选\"自动\"、尺寸选 1024 × 1024。", -1))
                          ], 64))
                        : _createCommentVNode("", true)
                    ])
                  ], 64))
                  ...
                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                      ...
                      _createElementVNode("section", _hoisted_14, [
                        _createElementVNode("label", _hoisted_15, [
                          ...
                          _cache[27] || (_cache[27] = _createElementVNode("span", null, "私聊回复（私聊里直接对话）", -1))
                        ]),
                        _createElementVNode("label", _hoisted_16, [
                          ...
                          _cache[28] || (_cache[28] = _createElementVNode("span", null, "群聊回复（群里 @你 或回复你的消息时对话）", -1))
                        ]),
                        (cfg.enable_group_chat)
                          ? (_openBlock(), _createElementBlock("label", _hoisted_17, [
                              _cache[29] || (_cache[29] = _createElementVNode("span", null, "生效群组", -1)),
