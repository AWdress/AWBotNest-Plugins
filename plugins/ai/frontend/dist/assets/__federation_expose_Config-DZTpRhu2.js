...
const _hoisted_29 = { class: "row top" };
...
const _hoisted_39 = { class: "savebar" };
const _hoisted_40 = ["disabled"];
const _hoisted_41 = { class: "pane" };
...
const _hoisted_48 = { class: "mem-list" };
const _hoisted_49 = ["onClick"];
const _hoisted_50 = { class: "mem-h" };
const _hoisted_51 = { class: "mem-type" };
const _hoisted_52 = { class: "mem-id" };
const _hoisted_53 = { class: "mem-last" };
const _hoisted_54 = { class: "mem-meta" };
const _hoisted_55 = ["onClick"];
const _hoisted_56 = { class: "mem-detail" };
const _hoisted_57 = {
  key: 0,
  class: "muted center"
};
...
const _hoisted_60 = { class: "bubble-role" };
const _hoisted_61 = { class: "bubble-text" };
      ...
      : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
          ...
          _withDirectives(_createElementVNode("div", _hoisted_4, [
            _createElementVNode("aside", _hoisted_5, [
              _cache[22] || (_cache[22] = _createElementVNode("div", { class: "side-title" }, "设置分组", -1)),
            ...
            _createElementVNode("div", _hoisted_8, [
              (group.value === 'api')
                ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                    _cache[26] || (_cache[26] = _createElementVNode("h3", { class: "det-title" }, "OpenAI 兼容接口", -1)),
                ...
                : (group.value === 'image')
                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                      _cache[35] || (_cache[35] = _createElementVNode("h3", { class: "det-title" }, "AI 生图", -1)),
                      _createElementVNode("section", _hoisted_15, [
                        _createElementVNode("label", _hoisted_16, [
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((cfg.enable_image_generation) = $event)),
                            type: "checkbox"
                          }, null, 512), [
                            [_vModelCheckbox, cfg.enable_image_generation]
                          ]),
                          _cache[27] || (_cache[27] = _createElementVNode("span", null, "启用 AI 生图命令", -1))
                        ]),
                        _cache[34] || (_cache[34] = _createElementVNode("p", { class: "tip" }, "发送 /生图 画面描述 或 /draw prompt，生成后会直接把图片发到当前会话。", -1)),
                        (cfg.enable_image_generation)
                          ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                              _createElementVNode("label", _hoisted_17, [
                                _cache[28] || (_cache[28] = _createElementVNode("span", null, "生图模型", -1)),
                                _withDirectives(_createElementVNode("input", {
                                  "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((cfg.image_model) = $event)),
                                  class: "inp",
                                  placeholder: "gpt-image-1 / dall-e-3 / 兼容模型名"
                                }, null, 512), [
                                  [_vModelText, cfg.image_model]
                                ])
                              ]),
                              _createElementVNode("div", _hoisted_18, [
                                _createElementVNode("label", _hoisted_19, [
                                  _cache[30] || (_cache[30] = _createElementVNode("span", null, "图片尺寸", -1)),
                                  _withDirectives(_createElementVNode("select", {
                                    "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => ((cfg.image_size) = $event)),
                                    class: "inp"
                                  }, [...(_cache[29] || (_cache[29] = [
                                    _createStaticVNode("<option value=\"1024x1024\" data-v-61ea2532>1024 × 1024</option><option value=\"1536x1024\" data-v-61ea2532>1536 × 1024（横图）</option><option value=\"1024x1536\" data-v-61ea2532>1024 × 1536（竖图）</option><option value=\"1792x1024\" data-v-61ea2532>1792 × 1024（DALL·E 3 横图）</option><option value=\"1024x1792\" data-v-61ea2532>1024 × 1792（DALL·E 3 竖图）</option>", 5)
                                  ]))], 512), [
                                    [_vModelSelect, cfg.image_size]
                                  ])
                                ]),
                                _createElementVNode("label", _hoisted_20, [
                                  _cache[32] || (_cache[32] = _createElementVNode("span", null, "生成质量", -1)),
                                  _withDirectives(_createElementVNode("select", {
                                    "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((cfg.image_quality) = $event)),
                                    class: "inp"
                                  }, [...(_cache[31] || (_cache[31] = [
                                    _createStaticVNode("<option value=\"auto\" data-v-61ea2532>自动</option><option value=\"low\" data-v-61ea2532>低</option><option value=\"medium\" data-v-61ea2532>中</option><option value=\"high\" data-v-61ea2532>高</option><option value=\"standard\" data-v-61ea2532>标准（DALL·E）</option><option value=\"hd\" data-v-61ea2532>高清（DALL·E）</option>", 6)
                                  ]))], 512), [
                                    [_vModelSelect, cfg.image_quality]
                                  ])
                                ])
                              ]),
                              _cache[33] || (_cache[33] = _createElementVNode("p", { class: "tip" }, "不同兼容接口支持的尺寸和质量可能不同；不确定时质量选“自动”、尺寸选 1024 × 1024。", -1))
                            ], 64))
                          : _createCommentVNode("", true)
                      ])
                    ], 64))
                    ...
                    ? (_openBlock(), _createElementBlock(_Fragment, { key: 2 }, [
                        ...
                        _createElementVNode("section", _hoisted_21, [
                          _createElementVNode("label", _hoisted_22, [
                            _withDirectives(_createElementVNode("input", {
                              "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((cfg.enable_private_chat) = $event)),
                              type: "checkbox"
                            }, null, 512), [
                              [_vModelCheckbox, cfg.enable_private_chat]
                            ]),
                            _cache[36] || (_cache[36] = _createElementVNode("span", null, "私聊回复（私聊里直接对话）", -1))
                          ]),
                          _createElementVNode("label", _hoisted_23, [
                            _withDirectives(_createElementVNode("input", {
                              "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => ((cfg.enable_group_chat) = $event)),
                              type: "checkbox"
                            }, null, 512), [
                              [_vModelCheckbox, cfg.enable_group_chat]
                            ]),
                            _cache[37] || (_cache[37] = _createElementVNode("span", null, "群聊回复（群里 @你 或回复你的消息时对话）", -1))
                          ]),
                          (cfg.enable_group_chat)
                            ? (_openBlock(), _createElementBlock("label", _hoisted_24, [
                                _cache[38] || (_cache[38] = _createElementVNode("span", null, "生效群组", -1)),
                                _withDirectives(_createElementVNode("textarea", {
                                  "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((cfg.group_chat_ids) = $event)),
                                  class: "inp",
                                  rows: "2",
                          ...
                          _createElementVNode("label", _hoisted_25, [
                            _cache[39] || (_cache[39] = _createElementVNode("span", null, "人设", -1)),
                            _withDirectives(_createElementVNode("textarea", {
                              "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((cfg.system_prompt) = $event)),
                              class: "inp",
                              rows: "8",
                              placeholder: "系统提示词"
                            }, null, 512), [
                          ...
                          _createElementVNode("label", _hoisted_26, [
                            _cache[40] || (_cache[40] = _createElementVNode("span", null, "记忆轮数", -1)),
                            _withDirectives(_createElementVNode("input", {
                              "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((cfg.max_history) = $event)),
                              class: "inp sm",
                              type: "number",
                              min: "0",
                              max: "40"
                            ...
                            _cache[41] || (_cache[41] = _createElementVNode("span", { class: "hint" }, "每会话保留多少条历史，0=不记忆", -1))
                          ])
                        ])
                      ], 64))
                    : (group.value === 'proactive')
                      ? (_openBlock(), _createElementBlock(_Fragment, { key: 3 }, [
                          ...
                          _createElementVNode("section", _hoisted_27, [
                            _createElementVNode("label", _hoisted_28, [
                              _withDirectives(_createElementVNode("input", {
                                "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((cfg.enable_proactive) = $event)),
                                type: "checkbox"
                              }, null, 512), [
                            ...
                            (cfg.enable_proactive)
                              ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                                  _createElementVNode("label", _hoisted_29, [
                                    ...
                                    _withDirectives(_createElementVNode("textarea", {
                                      "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((cfg.proactive_chat_ids) = $event)),
                                      class: "inp",
                                      rows: "2",
                                  ...
                                  _createElementVNode("div", _hoisted_30, [
                                    _createElementVNode("label", _hoisted_31, [
                                      ...
                                      _withDirectives(_createElementVNode("input", {
                                        "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((cfg.proactive_min_minutes) = $event)),
                                        class: "inp sm",
                                        type: "number",
                                        min: "5",
                                        max: "720"
                                    ...
                                    _createElementVNode("label", _hoisted_32, [
                                      ...
                                      _withDirectives(_createElementVNode("input", {
                                        "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((cfg.proactive_max_minutes) = $event)),
                                        class: "inp sm",
                                        type: "number",
                                        min: "5",
                                        max: "1440"
                      ...
                      : (group.value === 'explain')
                        ? (_openBlock(), _createElementBlock(_Fragment, { key: 4 }, [
                            _cache[55] || (_cache[55] = _createElementVNode("h3", { class: "det-title" }, "/ai 解释命令", -1)),
                            _createElementVNode("section", _hoisted_33, [
                              _createElementVNode("label", _hoisted_34, [
                                _withDirectives(_createElementVNode("input", {
                                  "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((cfg.enable_explain_command) = $event)),
                                  type: "checkbox"
                                }, null, 512), [
                                  [_vModelCheckbox, cfg.enable_explain_command]
                                ]),
                                _cache[51] || (_cache[51] = _createElementVNode("span", null, "启用 /ai 解释命令", -1))
                              ]),
                              _cache[54] || (_cache[54] = _createElementVNode("p", { class: "tip" }, "回复一条消息（或图片）再发 /ai，让 AI 解释/解答（单次，无记忆）。", -1)),
                              (cfg.enable_explain_command)
                                ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                                    _createElementVNode("label", _hoisted_35, [
                                      _withDirectives(_createElementVNode("input", {
                                        "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((cfg.enable_explain_prompt) = $event)),
                                        type: "checkbox"
                                      }, null, 512), [
                                        [_vModelCheckbox, cfg.enable_explain_prompt]
                                      ]),
                                      _cache[52] || (_cache[52] = _createElementVNode("span", null, "用解释模板（否则直接把内容丢给 AI）", -1))
                                    ]),
                                    (cfg.enable_explain_prompt)
                                      ? (_openBlock(), _createElementBlock("label", _hoisted_36, [
                                          _cache[53] || (_cache[53] = _createElementVNode("span", null, "解释模板", -1)),
                                          _withDirectives(_createElementVNode("textarea", {
                                            "onUpdate:modelValue": _cache[20] || (_cache[20] = $event => ((cfg.explain_prompt) = $event)),
                                            class: "inp",
                                            rows: "6",
                        ...
                        : (group.value === 'scope')
                          ? (_openBlock(), _createElementBlock(_Fragment, { key: 5 }, [
                              _cache[57] || (_cache[57] = _createElementVNode("h3", { class: "det-title" }, "生效范围", -1)),
                              _createElementVNode("section", _hoisted_37, [
                                _createElementVNode("label", _hoisted_38, [
                                  _cache[56] || (_cache[56] = _createElementVNode("span", null, "会话白名单", -1)),
                                  _withDirectives(_createElementVNode("textarea", {
                                    "onUpdate:modelValue": _cache[21] || (_cache[21] = $event => ((cfg.white_list_chats) = $event)),
                                    class: "inp",
                                    rows: "2",
              ...
              _createElementVNode("div", _hoisted_39, [
                _createElementVNode("button", {
                  ...
                  onClick: save
                }, _toDisplayString(saving.value ? '保存中…' : '保存配置'), 9, _hoisted_40)
              ])
            ])
          ], 512), [
          ...
          _withDirectives(_createElementVNode("div", _hoisted_41, [
            _createElementVNode("div", _hoisted_42, [
              _createElementVNode("span", _hoisted_43, "下次主动搭话：" + _toDisplayString(proactiveNext.value || '—'), 1),
              _cache[58] || (_cache[58] = _createElementVNode("span", { class: "grow" }, null, -1)),
              _createElementVNode("button", {
                class: "btn",
            ...
            (histLoading.value)
              ? (_openBlock(), _createElementBlock("div", _hoisted_45, "加载中…"))
              : (!histories.value.length)
                ? (_openBlock(), _createElementBlock("div", _hoisted_46, [...(_cache[59] || (_cache[59] = [
                ...
                : (_openBlock(), _createElementBlock("div", _hoisted_47, [
                      ...
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(histories.value, (h) => {
                        return (_openBlock(), _createElementBlock("button", {
                          ...
                          _createElementVNode("div", _hoisted_50, [
                            _createElementVNode("span", _hoisted_51, _toDisplayString(h.is_private ? '私聊' : '群'), 1),
                            _createElementVNode("span", _hoisted_52, _toDisplayString(h.chat_id), 1)
                          ]),
                          _createElementVNode("div", _hoisted_53, _toDisplayString(h.last || '—'), 1),
                    ...
                    _createElementVNode("div", _hoisted_56, [
                      (!activeChat.value)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_57, "← 选择一个会话查看历史"))
                        : (msgLoading.value)
                          ...
                          : (_openBlock(), _createElementBlock("div", _hoisted_59, [
                              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(chatMessages.value, (m, i) => {
                                return (_openBlock(), _createElementBlock("div", {
                                  ...
                                  _createElementVNode("div", _hoisted_60, _toDisplayString(m.role === 'user' ? '对方' : '我'), 1),
                                  _createElementVNode("div", _hoisted_61, _toDisplayString(m.content), 1)
                                ], 2))
                              }), 128))
                            ]))
                    ])
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-61ea2532"]]);
