...
__plugin__ = {
    ...
    "icon": "https://raw.githubusercontent.com/AWdress/AWBotNest-Plugins/main/plugins/icons/pt_checkin.svg",
    "changelog": "v2.1.1 修复配置界面开关布局并更换专属图标\n- 开关使用固定轨道尺寸和独立栅格，避免宿主样式挤压重叠\n- 新增 PT 多站签到专属 SVG 图标\n\nv2.1.0 重做 Vue 管理界面",
    "scope": "standalone",
