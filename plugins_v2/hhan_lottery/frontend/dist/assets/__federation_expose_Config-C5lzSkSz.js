...
const {createElementVNode:_createElementVNode$4,toDisplayString:_toDisplayString$3,createTextVNode:_createTextVNode$2,normalizeClass:_normalizeClass$4,openBlock:_openBlock$4,createElementBlock:_createElementBlock$4,createCommentVNode:_createCommentVNode$4,normalizeStyle:_normalizeStyle$1,renderList:_renderList$1,Fragment:_Fragment$3,vModelCheckbox:_vModelCheckbox$2,withDirectives:_withDirectives$3,vModelSelect:_vModelSelect,vModelText:_vModelText$2} = await importShared('vue');
...
const _hoisted_3$3 = { class: "progress-card" };
const _hoisted_4$3 = { class: "progress-top" };
const _hoisted_5$3 = { class: "track" };
const _hoisted_6$3 = { class: "live-stats" };
const _hoisted_7$3 = { class: "stats-head" };
const _hoisted_8$3 = { class: "balance-line" };
const _hoisted_9$3 = { key: 0 };
const _hoisted_10$3 = {
  key: 1,
  class: "empty-stat"
};
const _hoisted_11$3 = { class: "stats-head" };
const _hoisted_12$2 = { class: "balance-line" };
const _hoisted_13$2 = { key: 0 };
const _hoisted_14$2 = {
  key: 1,
  class: "empty-stat"
};
const _hoisted_15$2 = { class: "grid" };
const _hoisted_16$1 = { class: "card settings" };
const _hoisted_17$1 = { class: "card-heading" };
const _hoisted_18$1 = { class: "toggle-row" };
const _hoisted_19$1 = { class: "settings-columns" };
const _hoisted_20$1 = { class: "setting-group" };
...
const _hoisted_29$1 = { class: "feature-toggle" };
const _hoisted_30$1 = {
  key: 0,
  class: "stop-box prize-notice-box"
};
const _hoisted_31$1 = { class: "prize-options" };
const _hoisted_32$1 = { class: "check" };
const _hoisted_33$1 = { class: "check" };
const _hoisted_34$1 = { class: "check" };
const _hoisted_35$1 = { class: "input-unit" };
const _hoisted_36$1 = { class: "feature-toggle" };
const _hoisted_37$1 = {
  key: 1,
  class: "stop-box"
};
const _hoisted_38$1 = { class: "prize-options" };
const _hoisted_39 = { class: "check" };
const _hoisted_40 = { class: "check" };
const _hoisted_41 = { class: "check" };
const _hoisted_42 = { class: "notification-options" };
...
const _hoisted_47 = { class: "card result" };
...
const apiError = ref$4('');
let timer;

const progress = computed$2(() => status.value.target ? Math.min(100, Math.round(status.value.completed / status.value.target * 100)) : 0);
const stateText = computed$2(() => apiError.value ? '状态连接失败' : (status.value.running ? `正在抽奖 ${status.value.completed}/${status.value.target}` : (status.value.detail || '等待开始')));
...
return (_ctx, _cache) => {
  return (_openBlock$4(), _createElementBlock$4("section", _hoisted_1$4, [
    _createElementVNode$4("header", null, [
      _cache[30] || (_cache[30] = _createElementVNode$4("div", null, [
      ...
      _createElementVNode$4("span", {
        ...
        _cache[29] || (_cache[29] = _createElementVNode$4("i", null, null, -1)),
        _createTextVNode$2(_toDisplayString$3(stateText.value), 1)
      ], 2)
    ]),
    (apiError.value)
      ? (_openBlock$4(), _createElementBlock$4("p", _hoisted_2$4, "无法读取转盘状态：" + _toDisplayString$3(apiError.value) + "。请检查插件后端启动日志或重新加载插件。", 1))
      ...
      _createElementVNode$4("div", _hoisted_6$3, [
        _createElementVNode$4("section", null, [
          _createElementVNode$4("div", _hoisted_7$3, [
            _cache[31] || (_cache[31] = _createElementVNode$4("h3", null, "当前任务", -1)),
          ...
          (prizeRows(currentStats.value).length)
            ? (_openBlock$4(), _createElementBlock$4("ul", _hoisted_9$3, [
            ...
            : (_openBlock$4(), _createElementBlock$4("p", _hoisted_10$3, "本轮奖品将在这里实时累积。"))
        ]),
        _createElementVNode$4("section", null, [
          _createElementVNode$4("div", _hoisted_11$3, [
            _cache[32] || (_cache[32] = _createElementVNode$4("h3", null, "累计奖品", -1)),
          ...
          (prizeRows(cumulativeStats.value).length)
            ? (_openBlock$4(), _createElementBlock$4("ul", _hoisted_13$2, [
            ...
            : (_openBlock$4(), _createElementBlock$4("p", _hoisted_14$2, "完成第一次抽奖后显示累计记录。"))
        ])
      ])
    ]),
    _createElementVNode$4("div", _hoisted_15$2, [
      _createElementVNode$4("div", _hoisted_16$1, [
        _createElementVNode$4("div", _hoisted_17$1, [
          _cache[34] || (_cache[34] = _createElementVNode$4("div", null, [
            _createElementVNode$4("h3", null, "抽奖设置"),
            _createElementVNode$4("p", null, "配置抽取策略、停止条件与结果通知。")
          ], -1)),
          _createElementVNode$4("label", _hoisted_18$1, [
            _cache[33] || (_cache[33] = _createElementVNode$4("span", null, [
              _createElementVNode$4("b", null, "启用转盘"),
              _createElementVNode$4("small", null, "允许启动新任务")
            ], -1)),
        ...
        _createElementVNode$4("div", _hoisted_19$1, [
          _createElementVNode$4("section", _hoisted_20$1, [
            _cache[44] || (_cache[44] = _createElementVNode$4("h4", null, "抽取与计划", -1)),
            _createElementVNode$4("label", null, [
              _cache[36] || (_cache[36] = _createElementVNode$4("span", null, "抽奖方式", -1)),
            ...
            (cfg.lottery_mode === 'fixed')
              ? (_openBlock$4(), _createElementBlock$4("label", _hoisted_21$1, [
                  _cache[37] || (_cache[37] = _createElementVNode$4("span", null, "抽奖次数", -1)),
                  _withDirectives$3(_createElementVNode$4("input", {
              ...
              : (cfg.lottery_mode === 'reserve')
                ? (_openBlock$4(), _createElementBlock$4("label", _hoisted_22$1, [
                    _cache[38] || (_cache[38] = _createElementVNode$4("span", null, "保留憨豆", -1)),
                    _withDirectives$3(_createElementVNode$4("input", {
                ...
                : (_openBlock$4(), _createElementBlock$4("p", _hoisted_23$1, "启动时读取余额与单次消耗，自动计算本次可抽次数。")),
            _createElementVNode$4("label", null, [
              _cache[39] || (_cache[39] = _createElementVNode$4("span", null, "抽奖间隔（秒）", -1)),
              _withDirectives$3(_createElementVNode$4("input", {
            ...
            _createElementVNode$4("label", null, [
              _cache[40] || (_cache[40] = _createElementVNode$4("span", null, "余额校准间隔", -1)),
              _withDirectives$3(_createElementVNode$4("input", {
            ...
            _createElementVNode$4("label", _hoisted_24$1, [
              ...
              _cache[41] || (_cache[41] = _createTextVNode$2(" 校准时清理转盘通知", -1))
            ]),
            _cache[45] || (_cache[45] = _createElementVNode$4("div", { class: "group-divider" }, null, -1)),
            _createElementVNode$4("label", _hoisted_25$1, [
              ...
              _cache[42] || (_cache[42] = _createTextVNode$2(" 到指定日期时间自动停止", -1))
            ]),
            (cfg.scheduled_stop_enabled)
              ? (_openBlock$4(), _createElementBlock$4("label", _hoisted_26$1, [
                  _cache[43] || (_cache[43] = _createElementVNode$4("span", null, "停止日期时间", -1)),
                  _withDirectives$3(_createElementVNode$4("input", {
                    "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((cfg.scheduled_stop_at) = $event)),
                    type: "datetime-local"
                  }, null, 512), [
                    [_vModelText$2, cfg.scheduled_stop_at]
                  ])
                ]))
              : _createCommentVNode$4("", true),
            (cfg.scheduled_stop_enabled)
              ? (_openBlock$4(), _createElementBlock$4("p", _hoisted_27$1, "计划会持久化，平台重启后继续剩余任务，并按时停止。"))
              : _createCommentVNode$4("", true)
          ]),
          _createElementVNode$4("section", _hoisted_28$1, [
            _cache[62] || (_cache[62] = _createElementVNode$4("h4", null, "大奖与通知", -1)),
            _createElementVNode$4("label", _hoisted_29$1, [
              _cache[46] || (_cache[46] = _createElementVNode$4("span", null, [
                _createElementVNode$4("b", null, "实时大奖通知"),
                _createElementVNode$4("small", null, "命中后立即推送富文本表格")
              ], -1)),
              _withDirectives$3(_createElementVNode$4("input", {
                "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((cfg.prize_notify_enabled) = $event)),
                type: "checkbox"
              }, null, 512), [
                [_vModelCheckbox$2, cfg.prize_notify_enabled]
              ])
            ]),
            (cfg.prize_notify_enabled)
              ? (_openBlock$4(), _createElementBlock$4("div", _hoisted_30$1, [
                  _createElementVNode$4("div", _hoisted_31$1, [
                    _createElementVNode$4("label", _hoisted_32$1, [
                      _withDirectives$3(_createElementVNode$4("input", {
                        "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => ((cfg.prize_notify_vip) = $event)),
                        type: "checkbox"
                      }, null, 512), [
                        [_vModelCheckbox$2, cfg.prize_notify_vip]
                      ]),
                      _cache[47] || (_cache[47] = _createTextVNode$2(" VIP", -1))
                    ]),
                    _createElementVNode$4("label", _hoisted_33$1, [
                      _withDirectives$3(_createElementVNode$4("input", {
                        "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((cfg.prize_notify_invite) = $event)),
                        type: "checkbox"
                      }, null, 512), [
                        [_vModelCheckbox$2, cfg.prize_notify_invite]
                      ]),
                      _cache[48] || (_cache[48] = _createTextVNode$2(" 邀请", -1))
                    ]),
                    _createElementVNode$4("label", _hoisted_34$1, [
                      _withDirectives$3(_createElementVNode$4("input", {
                        "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((cfg.prize_notify_big_beans) = $event)),
                        type: "checkbox"
                      }, null, 512), [
                        [_vModelCheckbox$2, cfg.prize_notify_big_beans]
                      ]),
                      _cache[49] || (_cache[49] = _createTextVNode$2(" 大额憨豆", -1))
                    ])
                  ]),
                  _createElementVNode$4("label", null, [
                    _cache[50] || (_cache[50] = _createElementVNode$4("span", null, "大额门槛", -1)),
                    _withDirectives$3(_createElementVNode$4("input", {
                  ...
                  _createElementVNode$4("label", null, [
                    _cache[51] || (_cache[51] = _createElementVNode$4("span", null, "通知关键词", -1)),
                    _withDirectives$3(_createElementVNode$4("input", {
                      "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((cfg.prize_notify_keywords) = $event)),
                      type: "text",
                      placeholder: "逗号分隔"
                    }, null, 512), [
                      [_vModelText$2, cfg.prize_notify_keywords]
                    ])
                  ]),
                  _createElementVNode$4("label", null, [
                    _cache[53] || (_cache[53] = _createElementVNode$4("span", null, "相同奖品冷却", -1)),
                    _createElementVNode$4("div", _hoisted_35$1, [
                      _withDirectives$3(_createElementVNode$4("input", {
                        "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((cfg.prize_notify_cooldown) = $event)),
                        type: "number",
                        min: "0",
                        max: "86400"
                      }, null, 512), [
                        [
                          _vModelText$2,
                          cfg.prize_notify_cooldown,
                          void 0,
                          { number: true }
                        ]
                      ]),
                      _cache[52] || (_cache[52] = _createElementVNode$4("em", null, "秒", -1))
                    ])
                  ])
                ]))
              : _createCommentVNode$4("", true),
            _createElementVNode$4("label", _hoisted_36$1, [
              _cache[54] || (_cache[54] = _createElementVNode$4("span", null, [
                _createElementVNode$4("b", null, "命中大奖后自动停止"),
                _createElementVNode$4("small", null, "关闭时只通知，不中断任务")
              ], -1)),
              _withDirectives$3(_createElementVNode$4("input", {
                "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((cfg.stop_on_prize) = $event)),
                type: "checkbox"
              }, null, 512), [
            ...
            (cfg.stop_on_prize)
              ? (_openBlock$4(), _createElementBlock$4("div", _hoisted_37$1, [
                  _createElementVNode$4("div", _hoisted_38$1, [
                    _createElementVNode$4("label", _hoisted_39, [
                      _withDirectives$3(_createElementVNode$4("input", {
                        "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((cfg.stop_on_vip) = $event)),
                        type: "checkbox"
                      }, null, 512), [
                        [_vModelCheckbox$2, cfg.stop_on_vip]
                      ]),
                      _cache[55] || (_cache[55] = _createTextVNode$2(" VIP", -1))
                    ]),
                    _createElementVNode$4("label", _hoisted_40, [
                      _withDirectives$3(_createElementVNode$4("input", {
                        "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((cfg.stop_on_invite) = $event)),
                        type: "checkbox"
                      }, null, 512), [
                        [_vModelCheckbox$2, cfg.stop_on_invite]
                      ]),
                      _cache[56] || (_cache[56] = _createTextVNode$2(" 邀请", -1))
                    ]),
                    _createElementVNode$4("label", _hoisted_41, [
                      _withDirectives$3(_createElementVNode$4("input", {
                        "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((cfg.stop_on_big_beans) = $event)),
                        type: "checkbox"
                      }, null, 512), [
                        [_vModelCheckbox$2, cfg.stop_on_big_beans]
                      ]),
                      _cache[57] || (_cache[57] = _createTextVNode$2(" 大额憨豆", -1))
                    ])
                  ]),
                  _createElementVNode$4("label", null, [
                    _cache[58] || (_cache[58] = _createElementVNode$4("span", null, "大额门槛", -1)),
                    _withDirectives$3(_createElementVNode$4("input", {
                      "onUpdate:modelValue": _cache[20] || (_cache[20] = $event => ((cfg.big_bean_threshold) = $event)),
                      type: "number",
                      min: "1",
                      step: "10000"
                    }, null, 512), [
                  ...
                  _createElementVNode$4("label", null, [
                    _cache[59] || (_cache[59] = _createElementVNode$4("span", null, "自定义关键词", -1)),
                    _withDirectives$3(_createElementVNode$4("input", {
                      "onUpdate:modelValue": _cache[21] || (_cache[21] = $event => ((cfg.stop_prize_keywords) = $event)),
                      type: "text",
                      placeholder: "逗号分隔"
                    }, null, 512), [
                      [_vModelText$2, cfg.stop_prize_keywords]
                    ])
                  ])
                ]))
              : _createCommentVNode$4("", true),
            _createElementVNode$4("div", _hoisted_42, [
              _createElementVNode$4("label", _hoisted_43, [
                _withDirectives$3(_createElementVNode$4("input", {
                  "onUpdate:modelValue": _cache[22] || (_cache[22] = $event => ((cfg.notify_result) = $event)),
                  type: "checkbox"
                }, null, 512), [
                  [_vModelCheckbox$2, cfg.notify_result]
                ]),
                _cache[60] || (_cache[60] = _createTextVNode$2(" 完成结果", -1))
              ]),
              _createElementVNode$4("label", _hoisted_44, [
                _withDirectives$3(_createElementVNode$4("input", {
                  "onUpdate:modelValue": _cache[23] || (_cache[23] = $event => ((cfg.notify_cookie_error) = $event)),
                  type: "checkbox"
                }, null, 512), [
                  [_vModelCheckbox$2, cfg.notify_cookie_error]
                ]),
                _cache[61] || (_cache[61] = _createTextVNode$2(" Cookie 异常", -1))
              ])
            ])
          ])
        ]),
        _createElementVNode$4("div", _hoisted_45, [
          _createElementVNode$4("button", {
            class: "secondary",
            disabled: saving.value,
            onClick: _cache[24] || (_cache[24] = $event => (save()))
          }, _toDisplayString$3(saving.value ? '保存中…' : '保存设置'), 9, _hoisted_46)
        ])
      ]),
      _createElementVNode$4("div", _hoisted_47, [
        _cache[63] || (_cache[63] = _createElementVNode$4("div", { class: "result-heading" }, [
          _createElementVNode$4("h3", null, "最近结果"),
          _createElementVNode$4("span", null, "自动刷新")
        ], -1)),
    ...
    _createElementVNode$4("footer", null, [
      _createElementVNode$4("button", {
        ...
        onClick: _cache[25] || (_cache[25] = $event => (action('run', '/lottery/run')))
      }, _toDisplayString$3(busy.value === 'run' ? '正在启动…' : '开始抽奖'), 9, _hoisted_48),
      _createElementVNode$4("button", {
        class: "danger",
        disabled: busy.value || !status.value.running,
        onClick: _cache[26] || (_cache[26] = $event => (action('stop', '/lottery/stop')))
      }, "停止抽奖", 8, _hoisted_49),
      _createElementVNode$4("button", {
        class: "secondary",
        disabled: busy.value,
        onClick: _cache[27] || (_cache[27] = $event => (action('cookie', '/lottery/cookie/check', 'GET')))
      }, "检查 Cookie 与余额", 8, _hoisted_50),
      _createElementVNode$4("button", {
        class: "secondary",
        disabled: busy.value || status.value.running,
        onClick: _cache[28] || (_cache[28] = $event => (action('mail', '/lottery/mail/clean')))
      }, "清理转盘通知", 8, _hoisted_51)
    ])
  ]))
}
}
...
const LotteryPanel = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-f9cc74ab"]]);
...
const _hoisted_5$2 = { class: "title-wrap" };
const _hoisted_6$2 = ["innerHTML"];
const _hoisted_7$2 = {
  class: "run-area",
  "aria-labelledby": "run-heading"
};
const _hoisted_8$2 = { class: "run-copy" };
const _hoisted_9$2 = { class: "meta" };
...
const _hoisted_20 = { class: "content-grid" };
const _hoisted_21 = {
  class: "settings",
  "aria-labelledby": "settings-heading"
};
const _hoisted_22 = { class: "section-head" };
const _hoisted_23 = ["disabled"];
const _hoisted_24 = { class: "toggle-row" };
const _hoisted_25 = { class: "toggle-row" };
const _hoisted_26 = { class: "field-grid" };
const _hoisted_27 = { class: "input-unit" };
const _hoisted_28 = { class: "input-unit" };
const _hoisted_29 = {
  class: "history-area",
  "aria-labelledby": "history-heading"
};
const _hoisted_30 = { class: "section-head" };
const _hoisted_31 = { class: "head-actions" };
...
const _hoisted_38 = { class: "history-meta" };
  ...
  return (_openBlock$3(), _createElementBlock$3("div", _hoisted_1$3, [
    (loading.value)
      ...
      : (_openBlock$3(), _createElementBlock$3(_Fragment$2, { key: 1 }, [
          (apiError.value)
            ? (_openBlock$3(), _createElementBlock$3("p", _hoisted_3$2, "无法读取消息管理状态：" + _toDisplayString$2(apiError.value) + "。请检查插件是否完整启动。", 1))
            : _createCommentVNode$3("", true),
          _createElementVNode$3("header", _hoisted_4$2, [
          ...
          _createElementVNode$3("section", _hoisted_7$2, [
            _createElementVNode$3("div", _hoisted_8$2, [
              ...
              _createElementVNode$3("span", _hoisted_9$2, [
          ...
          _createElementVNode$3("div", _hoisted_20, [
            _createElementVNode$3("section", _hoisted_21, [
              _createElementVNode$3("div", _hoisted_22, [
                ...
                _createElementVNode$3("button", {
                  ...
                  disabled: saving.value,
                  onClick: save
                }, _toDisplayString$2(saving.value ? '保存中…' : '保存'), 9, _hoisted_23)
              ]),
              ...
              _createElementVNode$3("label", _hoisted_25, [
              ...
              _createElementVNode$3("div", _hoisted_26, [
                ...
                _createElementVNode$3("label", null, [
                  ...
                  _createElementVNode$3("div", _hoisted_28, [
                    _withDirectives$2(_createElementVNode$3("input", {
            ...
            _createElementVNode$3("section", _hoisted_29, [
              _createElementVNode$3("div", _hoisted_30, [
                ...
                _createElementVNode$3("div", _hoisted_31, [
                  _createElementVNode$3("button", {
                    class: "icon-button",
                    title: "刷新记录",
                    "aria-label": "刷新记录",
              ...
              (!history.value.length)
                ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_35, [
                    (_openBlock$3(), _createElementBlock$3("svg", {
                      viewBox: "0 0 24 24",
                      "aria-hidden": "true",
                      innerHTML: iconPath('inbox')
                ...
                : (_openBlock$3(), _createElementBlock$3("div", _hoisted_37, [
                    (_openBlock$3(true), _createElementBlock$3(_Fragment$2, null, _renderList(history.value, (item, index) => {
                      return (_openBlock$3(), _createElementBlock$3("article", {
                        ...
                        _createElementVNode$3("div", _hoisted_38, [
...
const ReadPanel = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-96148b49"]]);
...
const _hoisted_9$1 = { class: "switch-row" };
const _hoisted_10$1 = { class: "switch-row" };
const _hoisted_11$1 = { class: "fields" };
const _hoisted_12 = { class: "card guide" };
const _hoisted_13 = { class: "example" };
const _hoisted_14 = { class: "example" };
...
const props = __props;
const cfg = reactive$1({ bonus_enabled: true, auto_confirm_bonus_transfer: false, auto_grab_random_packet: false, random_packet_delay_min: 1, random_packet_delay_max: 5, notify_cookie_error: true, single_command: '.hh', batch_command: '.hhs', cooldown_seconds: 10, result_delete: 90 });
    ...
    (loading.value)
      ...
      : (_openBlock$2(), _createElementBlock$2(_Fragment$1, { key: 1 }, [
          _createElementVNode$2("header", null, [
            _cache[11] || (_cache[11] = _createElementVNode$2("div", null, [
            ...
            _createElementVNode$2("span", {
              ...
              _cache[10] || (_cache[10] = _createElementVNode$2("i", null, null, -1)),
          ...
          _createElementVNode$2("div", _hoisted_3$1, [
            _createElementVNode$2("section", _hoisted_4$1, [
              ...
              _createElementVNode$2("label", _hoisted_7$1, [
                _cache[13] || (_cache[13] = _createElementVNode$2("span", null, [
              ...
              _createElementVNode$2("label", _hoisted_8$1, [
                _cache[14] || (_cache[14] = _createElementVNode$2("span", null, [
                  _createElementVNode$2("b", null, "自动确认憨豆转赠"),
                  _createElementVNode$2("small", null, "仅确认官方机器人 8780479105 对本账号赠豆命令发出的二次确认")
                ], -1)),
                _withDirectives$1(_createElementVNode$2("input", {
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => ((cfg.auto_confirm_bonus_transfer) = $event)),
                  type: "checkbox",
                  role: "switch"
                }, null, 512), [
                  [_vModelCheckbox, cfg.auto_confirm_bonus_transfer]
                ])
              ]),
              _createElementVNode$2("label", _hoisted_9$1, [
                _cache[15] || (_cache[15] = _createElementVNode$2("span", null, [
                  _createElementVNode$2("b", null, "自动领取随机红包"),
                  _createElementVNode$2("small", null, "解析官方机器人 8780479105 发布的口令红包，随机等待后发送口令")
                ], -1)),
                _withDirectives$1(_createElementVNode$2("input", {
                  "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => ((cfg.auto_grab_random_packet) = $event)),
                  type: "checkbox",
                  role: "switch"
                }, null, 512), [
                  [_vModelCheckbox, cfg.auto_grab_random_packet]
                ])
              ]),
              _createElementVNode$2("label", _hoisted_10$1, [
                _cache[16] || (_cache[16] = _createElementVNode$2("span", null, [
                  _createElementVNode$2("b", null, "Cookie 异常时通知"),
                  _createElementVNode$2("small", null, "登录态失效时通过平台通知提醒")
                ], -1)),
                _withDirectives$1(_createElementVNode$2("input", {
                  "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => ((cfg.notify_cookie_error) = $event)),
                  type: "checkbox",
                  role: "switch"
                }, null, 512), [
              ...
              _createElementVNode$2("div", _hoisted_11$1, [
                _createElementVNode$2("label", null, [
                  _cache[17] || (_cache[17] = _createElementVNode$2("span", null, "单人命令", -1)),
                  _withDirectives$1(_createElementVNode$2("input", {
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((cfg.single_command) = $event)),
                    type: "text",
                    placeholder: ".hh"
                  }, null, 512), [
                    [_vModelText, cfg.single_command]
                  ])
                ]),
                _createElementVNode$2("label", null, [
                  _cache[18] || (_cache[18] = _createElementVNode$2("span", null, "批量命令", -1)),
                  _withDirectives$1(_createElementVNode$2("input", {
                    "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((cfg.batch_command) = $event)),
                    type: "text",
                    placeholder: ".hhs"
                  }, null, 512), [
                    [_vModelText, cfg.batch_command]
                  ])
                ]),
                _createElementVNode$2("label", null, [
                  _cache[20] || (_cache[20] = _createElementVNode$2("span", null, "赠送冷却", -1)),
                  _createElementVNode$2("div", null, [
                    _withDirectives$1(_createElementVNode$2("input", {
                      "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((cfg.cooldown_seconds) = $event)),
                      type: "number",
                      min: "0",
                      max: "600"
                    }, null, 512), [
                    ...
                    _cache[19] || (_cache[19] = _createElementVNode$2("em", null, "秒", -1))
                  ])
                ]),
                _createElementVNode$2("label", null, [
                  _cache[22] || (_cache[22] = _createElementVNode$2("span", null, "结果保留", -1)),
                  _createElementVNode$2("div", null, [
                    _withDirectives$1(_createElementVNode$2("input", {
                      "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => ((cfg.result_delete) = $event)),
                      type: "number",
                      min: "10",
                      max: "600"
                    }, null, 512), [
                    ...
                    _cache[21] || (_cache[21] = _createElementVNode$2("em", null, "秒", -1))
                  ])
                ]),
                _createElementVNode$2("label", null, [
                  _cache[24] || (_cache[24] = _createElementVNode$2("span", null, "红包最短延迟", -1)),
                  _createElementVNode$2("div", null, [
                    _withDirectives$1(_createElementVNode$2("input", {
                      "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((cfg.random_packet_delay_min) = $event)),
                      type: "number",
                      min: "0",
                      max: "3600",
                      step: "0.5"
                      ...
                      [
                        _vModelText,
                        cfg.random_packet_delay_min,
                        void 0,
                        { number: true }
                      ]
                    ]),
                    _cache[23] || (_cache[23] = _createElementVNode$2("em", null, "秒", -1))
                  ])
                ]),
                _createElementVNode$2("label", null, [
                  _cache[26] || (_cache[26] = _createElementVNode$2("span", null, "红包最长延迟", -1)),
                  _createElementVNode$2("div", null, [
                    _withDirectives$1(_createElementVNode$2("input", {
                      "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((cfg.random_packet_delay_max) = $event)),
                      type: "number",
                      min: "0",
                      max: "3600",
                      step: "0.5"
                      ...
                      [
                        _vModelText,
                        cfg.random_packet_delay_max,
                        void 0,
                        { number: true }
                      ]
                    ]),
                    _cache[25] || (_cache[25] = _createElementVNode$2("em", null, "秒", -1))
                  ])
                ])
              ])
            ]),
            _createElementVNode$2("aside", _hoisted_12, [
              _cache[29] || (_cache[29] = _createElementVNode$2("h3", null, "命令格式", -1)),
              _createElementVNode$2("div", _hoisted_13, [
                _cache[27] || (_cache[27] = _createElementVNode$2("span", null, "单人赠送", -1)),
              ...
              _createElementVNode$2("div", _hoisted_14, [
                _cache[28] || (_cache[28] = _createElementVNode$2("span", null, "批量赠送", -1)),
                _createElementVNode$2("code", null, _toDisplayString$1(cfg.batch_command || '.hhs') + " Alice Bob 100 感谢", 1)
              ]),
              _cache[30] || (_cache[30] = _createElementVNode$2("ul", null, [
                _createElementVNode$2("li", null, "站点最低赠送 100 憨豆"),
                _createElementVNode$2("li", null, "批量任务最多 50 位用户"),
                _createElementVNode$2("li", null, "自动确认只识别官方机器人和“确认赠送”按钮"),
                _createElementVNode$2("li", null, "随机红包按账号、群组和消息去重，不会重复发送口令")
              ], -1)),
              _createElementVNode$2("button", {
                class: "secondary",
                disabled: checking.value,
                onClick: checkCookie
              }, _toDisplayString$1(checking.value ? '检查中…' : '检查平台 Cookie'), 9, _hoisted_15)
            ])
          ])
        ], 64))
  ]))
...
const BonusPanel = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-3601be80"]]);

const {openBlock:_openBlock$1,createElementBlock:_createElementBlock$1,createCommentVNode:_createCommentVNode$1,createElementVNode:_createElementVNode$1,toDisplayString:_toDisplayString,vModelRadio:_vModelRadio,withDirectives:_withDirectives,normalizeClass:_normalizeClass$1,vModelDynamic:_vModelDynamic,Fragment:_Fragment} = await importShared('vue');
...
const _hoisted_7 = { class: "secret-field" };
...
const cookieVisible = ref$1(false);
...
onMounted(async () => {
  try { const saved = await props.host.getConfig() || {}; if (saved.manual_cookie === '********') saved.manual_cookie = await props.host.revealSecret('manual_cookie'); Object.assign(cfg, saved); }
      ...
      : (_openBlock$1(), _createElementBlock$1(_Fragment, { key: 1 }, [
          ...
          _createElementVNode$1("div", _hoisted_4, [
            _createElementVNode$1("label", {
              ...
              _cache[6] || (_cache[6] = _createElementVNode$1("span", { class: "radio-dot" }, null, -1)),
              _cache[7] || (_cache[7] = _createElementVNode$1("span", null, [
            ...
            _createElementVNode$1("label", {
              ...
              _cache[8] || (_cache[8] = _createElementVNode$1("span", { class: "radio-dot" }, null, -1)),
          ...
          _createElementVNode$1("section", {
            ...
            _createElementVNode$1("div", _hoisted_5, [
              _cache[10] || (_cache[10] = _createElementVNode$1("div", null, [
            ...
            _createElementVNode$1("div", _hoisted_7, [
              _withDirectives(_createElementVNode$1("input", {
                ...
                [_vModelDynamic, cfg.manual_cookie]
              ]),
              _createElementVNode$1("button", {
                type: "button",
                disabled: !hasManual.value,
                "aria-label": cookieVisible.value ? '隐藏 Cookie' : '显示 Cookie',
                onClick: _cache[3] || (_cache[3] = $event => (cookieVisible.value = !cookieVisible.value))
              }, [...(_cache[11] || (_cache[11] = [
                _createElementVNode$1("svg", {
                  viewBox: "0 0 24 24",
                  "aria-hidden": "true"
                }, [
                  _createElementVNode$1("path", { d: "M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z" }),
            ...
            _cache[12] || (_cache[12] = _createElementVNode$1("p", { class: "security" }, "Cookie 相当于账号登录凭证。请勿发送给他人，建议定期更新。", -1))
          ], 2),
          (checked.value)
          ...
          _createElementVNode$1("footer", null, [
            ...
            }, _toDisplayString(saving.value ? '保存中…' : '保存设置'), 9, _hoisted_10),
            _createElementVNode$1("button", {
              class: "secondary",
              disabled: saving.value || checking.value,
              onClick: check
            }, _toDisplayString(checking.value ? '检查中…' : '保存并检查连接'), 9, _hoisted_11)
          ])
        ], 64))
  ]))
}
...
const CookiePanel = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-cfd30030"]]);
