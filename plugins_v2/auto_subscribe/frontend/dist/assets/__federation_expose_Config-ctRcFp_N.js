...
const _hoisted_68 = { class: "fld" };
const _hoisted_69 = { class: "chips" };
const _hoisted_70 = ["checked", "onChange"];
const _hoisted_71 = { class: "fld" };
const _hoisted_72 = { class: "chips scroll" };
...
const _hoisted_87 = { class: "fld" };
const _hoisted_88 = { class: "chips" };
const _hoisted_89 = ["checked", "onChange"];
const _hoisted_90 = { class: "fld" };
const _hoisted_91 = { class: "chips" };
...
const _hoisted_103 = { class: "stats" };
const _hoisted_104 = { class: "stat-l" };
const _hoisted_105 = { class: "toolbar" };
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    (loading.value)
      ...
      : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
              ...
              (group.value === 'global')
                ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                    ...
                    _createElementVNode("section", _hoisted_10, [
                      _cache[50] || (_cache[50] = _createElementVNode("div", { class: "card-h" }, "NextFind 连接", -1)),
                      _createElementVNode("div", _hoisted_11, [
                        ...
                        _createElementVNode("label", _hoisted_13, [
                          _cache[49] || (_cache[49] = _createElementVNode("span", null, "密钥", -1)),
                          _withDirectives(_createElementVNode("input", {
                    ...
                    _createElementVNode("section", _hoisted_16, [
                      ...
                      _createElementVNode("div", _hoisted_17, [
                        _createElementVNode("label", _hoisted_18, [
                          _cache[51] || (_cache[51] = _createElementVNode("span", null, "定时(cron)", -1)),
                          _withDirectives(_createElementVNode("input", {
                        ...
                        _createElementVNode("label", _hoisted_19, [
                          ...
                          _cache[52] || (_cache[52] = _createElementVNode("span", null, "推送运行结果", -1))
                        ]),
                        _createElementVNode("label", _hoisted_20, [
                          ...
                          _cache[53] || (_cache[53] = _createElementVNode("span", null, "平台 AI 辅助识别", -1))
                        ]),
                        _createElementVNode("label", _hoisted_21, [
                          ...
                          _cache[54] || (_cache[54] = _createElementVNode("span", null, "自动补缺集", -1))
                        ]),
                        (cfg.auto_fill_missing)
                          ? (_openBlock(), _createElementBlock("label", _hoisted_22, [
                              _cache[55] || (_cache[55] = _createElementVNode("span", null, "每轮补缺上限", -1)),
                              _withDirectives(_createElementVNode("input", {
                        ...
                        _createElementVNode("label", _hoisted_23, [
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => ((cfg.auto_subscribe_missing) = $event)),
                            type: "checkbox"
                          }, null, 512), [
                            [_vModelCheckbox, cfg.auto_subscribe_missing]
                          ]),
                          _cache[56] || (_cache[56] = _createElementVNode("span", null, "本地缺集自动订阅", -1))
                        ]),
                        (cfg.auto_subscribe_missing)
                          ? (_openBlock(), _createElementBlock("label", _hoisted_24, [
                              _cache[57] || (_cache[57] = _createElementVNode("span", null, "每轮缺集订阅上限", -1)),
                              _withDirectives(_createElementVNode("input", {
                                "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((cfg.auto_subscribe_missing_limit) = $event)),
                                class: "inp",
                                type: "number",
                                min: "1",
                                max: "100"
                      ...
                      (cfg.ai_assist_recognition)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_25, "仅在常规搜索无结果时调用平台 AI 清洗片名、判断电影/剧集及季号；识别结果仍须经 NextFind 核验，平台 AI 不可用时自动降级。"))
                        : _createCommentVNode("", true),
                      (cfg.auto_fill_missing)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_26, "批量检查 NextFind 活跃剧集的入库进度，只将明确缺集的订阅推入高优搜索队列；无需启用榜单源。"))
                        : _createCommentVNode("", true),
                      _createElementVNode("div", _hoisted_27, [
                        _createElementVNode("button", {
                          ...
                          onClick: runNow
                        }, _toDisplayString(running.value ? '运行中…' : '立即运行一次'), 9, _hoisted_28)
                      ]),
                      (runOutput.value)
                        ? (_openBlock(), _createElementBlock("pre", _hoisted_29, _toDisplayString(runOutput.value), 1))
                        : _createCommentVNode("", true)
                    ]),
                          ...
                          _withDirectives(_createElementVNode("select", {
                            ...
                            (_openBlock(), _createElementBlock(_Fragment, null, _renderList(MEDIA_TYPES, (o) => {
                              return _createElementVNode("option", {
                                key: o.v,
                                value: o.v
                              }, _toDisplayString(o.l), 9, _hoisted_36)
                            }), 64))
                          ], 512), [
                                      ...
                                      _withDirectives(_createElementVNode("select", {
                                        ...
                                        (_openBlock(), _createElementBlock(_Fragment, null, _renderList(MEDIA_TYPES, (o) => {
                                          return _createElementVNode("option", {
                                            key: o.v,
                                            value: o.v
                                          }, _toDisplayString(o.l), 9, _hoisted_49)
                                        }), 64))
                                      ], 512), [
                                    ...
                                    _withDirectives(_createElementVNode("select", {
                                      ...
                                      (_openBlock(), _createElementBlock(_Fragment, null, _renderList(MIKAN_SEASONS, (o) => {
                                        return _createElementVNode("option", {
                                          key: o.v,
                                          value: o.v
                                        }, _toDisplayString(o.l), 9, _hoisted_54)
                                      }), 64))
                                    ], 512), [
                                            ...
                                            _withDirectives(_createElementVNode("select", {
                                              ...
                                              (_openBlock(), _createElementBlock(_Fragment, null, _renderList(MEDIA_TYPES, (o) => {
                                                return _createElementVNode("option", {
                                                  key: o.v,
                                                  value: o.v
                                                }, _toDisplayString(o.l), 9, _hoisted_99)
                                              }), 64))
                                            ], 512), [
          ...
          _withDirectives(_createElementVNode("div", _hoisted_102, [
            _createElementVNode("div", _hoisted_103, [
              (_openBlock(), _createElementBlock(_Fragment, null, _renderList(STAT_CARDS, (k) => {
                return _createElementVNode("div", {
                  ...
                  _createElementVNode("div", _hoisted_104, _toDisplayString(STATUS_LABELS[k]), 1)
                ], 4)
              }), 64))
            ]),
            _createElementVNode("div", _hoisted_105, [
              _createElementVNode("span", _hoisted_106, "上次运行：" + _toDisplayString(lastRun.value || '—'), 1),
              ...
              _withDirectives(_createElementVNode("select", {
                ...
                (_openBlock(), _createElementBlock(_Fragment, null, _renderList(STATUS_LABELS, (l, k) => {
                  return _createElementVNode("option", {
                    key: k,
                    value: k
                  }, _toDisplayString(l), 9, _hoisted_107)
                }), 64))
              ], 512), [
            ...
            (historyLoading.value)
              ...
              : (!filteredHistory.value.length)
                ? (_openBlock(), _createElementBlock("div", _hoisted_109, [...(_cache[111] || (_cache[111] = [
                    _createTextVNode("暂无订阅历史记录", -1),
                    _createElementVNode("br", null, null, -1),
                    _createElementVNode("span", { class: "muted" }, "启用来源并运行后，这里会记录每次订阅结果", -1)
                  ]))]))
                : (_openBlock(), _createElementBlock("table", _hoisted_110, [
                    ...
                    _createElementVNode("tbody", null, [
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(filteredHistory.value, (h) => {
                        return (_openBlock(), _createElementBlock("tr", {
                          ...
                          _createElementVNode("td", _hoisted_111, _toDisplayString(h.source || '—'), 1),
                          _createElementVNode("td", _hoisted_112, _toDisplayString(h.time), 1),
                          _createElementVNode("td", null, [
                            _createElementVNode("button", {
                              class: "btn xs",
          ...
          _withDirectives(_createElementVNode("div", _hoisted_114, [
            ...
            (subsLoading.value)
              ...
              : (subsError.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_116, "读取失败：" + _toDisplayString(subsError.value), 1))
                : (!subs.value.length)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_117, [...(_cache[115] || (_cache[115] = [
                      _createTextVNode("暂无本插件创建的订阅", -1),
                      _createElementVNode("br", null, null, -1),
                      _createElementVNode("span", { class: "muted" }, "启用来源运行后，订阅会出现在这里", -1)
                    ]))]))
                  : (_openBlock(), _createElementBlock("table", _hoisted_118, [
                      ...
                      _createElementVNode("tbody", null, [
                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(subs.value, (s) => {
                          return (_openBlock(), _createElementBlock("tr", {
                            ...
                            _createElementVNode("td", _hoisted_119, _toDisplayString(s.year || '—'), 1),
                            _createElementVNode("td", _hoisted_120, _toDisplayString(s.rating || '—'), 1),
                            _createElementVNode("td", _hoisted_121, _toDisplayString(s.media_type === 'tv' ? `${s.local_episodes || 0}/${s.total_episodes || 0}` : (s.is_in_library ? '已入库' : '—')), 1),
                            _createElementVNode("td", _hoisted_122, _toDisplayString(s.sub_status || s.status || '—'), 1),
                            _createElementVNode("td", null, [
                              _createElementVNode("button", {
                                class: "btn xs danger",
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-6eebc8aa"]]);
