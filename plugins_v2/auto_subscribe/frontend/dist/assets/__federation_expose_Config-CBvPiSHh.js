...
const _hoisted_106 = { class: "stats" };
const _hoisted_107 = { class: "stat-l" };
    ...
    (loading.value)
      ...
      : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                    ...
                    _createElementVNode("section", _hoisted_19, [
                      ...
                      _createElementVNode("div", _hoisted_20, [
                        ...
                        _createElementVNode("label", _hoisted_26, [
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((cfg.auto_subscribe_missing) = $event)),
                            type: "checkbox"
                          }, null, 512), [
                      ...
                      _createElementVNode("div", _hoisted_30, [
                        _createElementVNode("button", {
                          ...
                          onClick: runNow
                        }, _toDisplayString(running.value ? '运行中…' : '立即运行一次'), 9, _hoisted_31)
                      ]),
                      (runOutput.value)
                        ? (_openBlock(), _createElementBlock("pre", _hoisted_32, _toDisplayString(runOutput.value), 1))
                        : _createCommentVNode("", true)
                    ]),
                                    ...
                                    _withDirectives(_createElementVNode("select", {
                                      ...
                                      (_openBlock(), _createElementBlock(_Fragment, null, _renderList(MIKAN_SEASONS, (o) => {
                                        return _createElementVNode("option", {
                                          key: o.v,
                                          value: o.v
                                        }, _toDisplayString(o.l), 9, _hoisted_57)
                                      }), 64))
                                    ], 512), [
                                      ...
                                      _withDirectives(_createElementVNode("select", {
                                        ...
                                        (_openBlock(), _createElementBlock(_Fragment, null, _renderList(NF_DATASETS, (o) => {
                                          return _createElementVNode("option", {
                                            key: o.v,
                                            value: o.v
                                          }, _toDisplayString(o.l), 9, _hoisted_69)
                                        }), 64))
                                      ], 512), [
                                          ...
                                          _withDirectives(_createElementVNode("select", {
                                            ...
                                            (_openBlock(), _createElementBlock(_Fragment, null, _renderList(MEDIA_TYPES, (o) => {
                                              return _createElementVNode("option", {
                                                key: o.v,
                                                value: o.v
                                              }, _toDisplayString(o.l), 9, _hoisted_86)
                                            }), 64))
                                          ], 512), [
                                            ...
                                            _withDirectives(_createElementVNode("select", {
                                              ...
                                              (_openBlock(), _createElementBlock(_Fragment, null, _renderList(MEDIA_TYPES, (o) => {
                                                return _createElementVNode("option", {
                                                  key: o.v,
                                                  value: o.v
                                                }, _toDisplayString(o.l), 9, _hoisted_102)
                                              }), 64))
                                            ], 512), [
            ...
            _createElementVNode("div", _hoisted_106, [
              (_openBlock(), _createElementBlock(_Fragment, null, _renderList(STAT_CARDS, (k) => {
                return _createElementVNode("div", {
                  ...
                  _createElementVNode("div", _hoisted_107, _toDisplayString(STATUS_LABELS[k]), 1)
                ], 4)
              }), 64))
            ]),
              ...
              _withDirectives(_createElementVNode("select", {
                ...
                (_openBlock(), _createElementBlock(_Fragment, null, _renderList(STATUS_LABELS, (l, k) => {
                  return _createElementVNode("option", {
                    key: k,
                    value: k
                  }, _toDisplayString(l), 9, _hoisted_110)
                }), 64))
              ], 512), [
                    ...
                    _createElementVNode("tbody", null, [
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(filteredHistory.value, (h) => {
                        return (_openBlock(), _createElementBlock("tr", {
                          ...
                          _createElementVNode("td", _hoisted_114, _toDisplayString(h.source || '—'), 1),
                          _createElementVNode("td", _hoisted_115, _toDisplayString(h.time), 1),
                          _createElementVNode("td", null, [
                            _createElementVNode("button", {
                              class: "btn xs",
          ...
          _withDirectives(_createElementVNode("div", _hoisted_117, [
            ...
            (subsLoading.value)
              ? (_openBlock(), _createElementBlock("div", _hoisted_118, "加载中…"))
              : (subsError.value)
                      ...
                      _createElementVNode("tbody", null, [
                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(subs.value, (s) => {
                          return (_openBlock(), _createElementBlock("tr", {
                            ...
                            _createElementVNode("td", _hoisted_122, _toDisplayString(s.year || '—'), 1),
                            _createElementVNode("td", _hoisted_123, _toDisplayString(s.rating || '—'), 1),
                            _createElementVNode("td", _hoisted_124, _toDisplayString(s.media_type === 'tv' ? `${s.local_episodes || 0}/${s.total_episodes || 0}` : (s.is_in_library ? '已入库' : '—')), 1),
                            _createElementVNode("td", _hoisted_125, _toDisplayString(s.sub_status || s.status || '—'), 1),
                            _createElementVNode("td", null, [
                              _createElementVNode("button", {
                                class: "btn xs danger",
