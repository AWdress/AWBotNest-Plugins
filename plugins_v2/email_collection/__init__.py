...
__plugin__ = {
    ...
    "config_schema": {
        ...
        "verification_prompt": {"type": "textarea", "default": "", "label": "验证码提示词", "help": "留空使用内置提示词。", "section": "AI 功能", "order": 32},
        "summary_prompt": {"type": "textarea", "default": "", "label": "概要提示词", "help": "留空使用内置提示词。", "section": "AI 功能", "order": 33},
        "ai_timeout": {"type": "integer", "default": 60, "min": 10, "max": 180, "label": "AI 超时（秒）", "section": "AI 功能", "order": 34},
