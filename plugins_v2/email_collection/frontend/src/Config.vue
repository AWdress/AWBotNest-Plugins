      ...
      <div class="switch-grid">
        ...
        <label>
          <span class="switch-copy">
            <strong>推送所有新邮件</strong>
            <small>开启后忽略关键词和验证码筛选，普通邮件也会推送；通常保持关闭。</small>
          </span>
          <input v-model="form.push_all" type="checkbox">
        </label>
      </div>
