...
const _hoisted_20 = { class: "row top" };
      ...
      : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
          ...
          _withDirectives(_createElementVNode("div", _hoisted_4, [
            _createElementVNode("aside", _hoisted_5, [
              _cache[46] || (_cache[46] = _createElementVNode("div", { class: "side-title" }, "设置分组", -1)),
            ...
            _createElementVNode("div", _hoisted_8, [
              (group.value === 'lottery')
                ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                    _cache[53] || (_cache[53] = _createElementVNode("h3", { class: "det-title" }, "自动抽奖", -1)),
                    _createElementVNode("section", _hoisted_9, [
                      _createElementVNode("label", _hoisted_10, [
                        ...
                        _cache[47] || (_cache[47] = _createElementVNode("span", null, "自动抽奖总开关", -1))
                      ]),
                      (cfg.auto_lottery_enabled)
                        ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                            _createElementVNode("div", _hoisted_11, [
                              _createElementVNode("label", _hoisted_12, [
                                _cache[48] || (_cache[48] = _createElementVNode("span", null, "抽奖机器人ID", -1)),
                                _withDirectives(_createElementVNode("input", {
                              ...
                              _createElementVNode("label", _hoisted_13, [
                                _cache[49] || (_cache[49] = _createElementVNode("span", null, "PT用户名", -1)),
                                _withDirectives(_createElementVNode("input", {
                            ...
                            _createElementVNode("label", _hoisted_14, [
                              _cache[50] || (_cache[50] = _createElementVNode("span", null, "抽奖时间段", -1)),
                              _withDirectives(_createElementVNode("input", {
                            ...
                            _createElementVNode("div", _hoisted_15, [
                              _cache[51] || (_cache[51] = _createElementVNode("span", { class: "lbl" }, "参与抽奖群组", -1)),
                            ...
                            _cache[52] || (_cache[52] = _createElementVNode("p", { class: "tip" }, "不选 = 全部群组都参与；选了则只在这些群参与（中奖回应也只在这些群发）。", -1))
                          ], 64))
                        : _createCommentVNode("", true)
                    ])
                  ], 64))
                : (group.value === 'participate')
                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                      _cache[57] || (_cache[57] = _createElementVNode("h3", { class: "det-title" }, "参与方式", -1)),
                      _createElementVNode("section", _hoisted_16, [
                        _createElementVNode("label", _hoisted_17, [
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => ((cfg.lottery_forward_enabled) = $event)),
                            type: "checkbox"
                          }, null, 512), [
                            [_vModelCheckbox, cfg.lottery_forward_enabled]
                          ]),
                          _cache[54] || (_cache[54] = _createElementVNode("span", null, "转发原始抽奖消息参与（关闭则直接发文本关键词）", -1))
                        ]),
                        _createElementVNode("label", _hoisted_18, [
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((cfg.lottery_forward_first_participant) = $event)),
                            type: "checkbox"
                          }, null, 512), [
                            [_vModelCheckbox, cfg.lottery_forward_first_participant]
                          ]),
                          _cache[55] || (_cache[55] = _createElementVNode("span", null, "转发第一个参与者（最多等30秒，超时降级）", -1))
                        ]),
                        _cache[56] || (_cache[56] = _createElementVNode("p", { class: "tip" }, "优先级：特殊格式(@、/)→转发原消息 > 转发第一参与者 > 转发原消息 > 直接发文本。", -1))
                      ])
                    ], 64))
                  : (group.value === 'prize')
                    ? (_openBlock(), _createElementBlock(_Fragment, { key: 2 }, [
                        _cache[61] || (_cache[61] = _createElementVNode("h3", { class: "det-title" }, "奖品匹配", -1)),
                        _createElementVNode("section", _hoisted_19, [
                          _createElementVNode("label", _hoisted_20, [
                            _cache[58] || (_cache[58] = _createElementVNode("span", null, "奖品列表", -1)),
                            _withDirectives(_createElementVNode("textarea", {
                              "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((cfg.prize_list) = $event)),
                              class: "inp",
                              rows: "4",
                          ...
                          _createElementVNode("label", _hoisted_21, [
                            _withDirectives(_createElementVNode("input", {
                              "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => ((cfg.only_listed_prizes) = $event)),
                              type: "checkbox"
                            }, null, 512), [
                              [_vModelCheckbox, cfg.only_listed_prizes]
                            ]),
                            _cache[59] || (_cache[59] = _createElementVNode("span", null, "单独匹配（自定义奖品名白名单：勾选后只参与奖品名命中下方列表的抽奖，列表中的群组ID被忽略；不勾选=除陷阱外全部都抽，默认）", -1))
                          ]),
                          _createElementVNode("label", _hoisted_22, [
                            _withDirectives(_createElementVNode("input", {
                              "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((cfg.prize_case_sensitive) = $event)),
                              type: "checkbox"
                            }, null, 512), [
                              [_vModelCheckbox, cfg.prize_case_sensitive]
                            ]),
                            _cache[60] || (_cache[60] = _createElementVNode("span", null, "奖品关键词区分大小写", -1))
                          ])
                        ])
                      ], 64))
                    : (group.value === 'trap')
                      ? (_openBlock(), _createElementBlock(_Fragment, { key: 3 }, [
                          _cache[71] || (_cache[71] = _createElementVNode("h3", { class: "det-title" }, "陷阱检测", -1)),
                          _createElementVNode("section", _hoisted_23, [
                            _createElementVNode("label", _hoisted_24, [
                              _withDirectives(_createElementVNode("input", {
                                "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((cfg.trap_enabled) = $event)),
                                type: "checkbox"
                              }, null, 512), [
                                [_vModelCheckbox, cfg.trap_enabled]
                              ]),
                              _cache[62] || (_cache[62] = _createElementVNode("span", null, "启用陷阱抽奖检测（命中任一特征则跳过）", -1))
                            ]),
                            (cfg.trap_enabled)
                              ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                                  _createElementVNode("label", _hoisted_25, [
                                    _withDirectives(_createElementVNode("input", {
                                      "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((cfg.trap_case_sensitive) = $event)),
                                      type: "checkbox"
                                    }, null, 512), [
                                      [_vModelCheckbox, cfg.trap_case_sensitive]
                                    ]),
                                    _cache[63] || (_cache[63] = _createElementVNode("span", null, "陷阱关键词区分大小写", -1))
                                  ]),
                                  _createElementVNode("label", _hoisted_26, [
                                    _withDirectives(_createElementVNode("input", {
                                      "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((cfg.trap_enable_prize_pattern_check) = $event)),
                                      type: "checkbox"
                                    }, null, 512), [
                                      [_vModelCheckbox, cfg.trap_enable_prize_pattern_check]
                                    ]),
                                    _cache[64] || (_cache[64] = _createElementVNode("span", null, "启用关键词检测", -1))
                                  ]),
                                  (cfg.trap_enable_prize_pattern_check)
                                    ? (_openBlock(), _createElementBlock("label", _hoisted_27, [
                                        _cache[65] || (_cache[65] = _createElementVNode("span", null, "可疑关键词", -1)),
                                        _withDirectives(_createElementVNode("textarea", {
                                          "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((cfg.trap_suspicious_keywords) = $event)),
                                          class: "inp",
                                          rows: "3",
                                          placeholder: "逗号或换行分隔"
                                        }, null, 512), [
                                  ...
                                  _createElementVNode("label", _hoisted_28, [
                                    _withDirectives(_createElementVNode("input", {
                                      "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((cfg.trap_enable_creator_blacklist) = $event)),
                                      type: "checkbox"
                                    }, null, 512), [
                                      [_vModelCheckbox, cfg.trap_enable_creator_blacklist]
                                    ]),
                                    _cache[66] || (_cache[66] = _createElementVNode("span", null, "启用创建者黑名单", -1))
                                  ]),
                                  (cfg.trap_enable_creator_blacklist)
                                    ? (_openBlock(), _createElementBlock("label", _hoisted_29, [
                                        _cache[67] || (_cache[67] = _createElementVNode("span", null, "创建者黑名单", -1)),
                                        _withDirectives(_createElementVNode("textarea", {
                                          "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((cfg.trap_blacklist_creator_ids) = $event)),
                                          class: "inp",
                                          rows: "2",
                                  ...
                                  _createElementVNode("label", _hoisted_30, [
                                    _withDirectives(_createElementVNode("input", {
                                      "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((cfg.trap_enable_participant_check) = $event)),
                                      type: "checkbox"
                                    }, null, 512), [
                                      [_vModelCheckbox, cfg.trap_enable_participant_check]
                                    ]),
                                    _cache[68] || (_cache[68] = _createElementVNode("span", null, "启用参与人数检测", -1))
                                  ]),
                                  (cfg.trap_enable_participant_check)
                                    ? (_openBlock(), _createElementBlock("label", _hoisted_31, [
                                        _cache[69] || (_cache[69] = _createElementVNode("span", null, "人数阈值", -1)),
                                        _withDirectives(_createElementVNode("input", {
                                          "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((cfg.trap_max_participants) = $event)),
                                          class: "inp sm",
                                          type: "number",
                                          min: "1",
                                          max: "1000"
                                        ...
                                        _cache[70] || (_cache[70] = _createElementVNode("span", { class: "hint" }, "参与人数 ≤ 此值视为陷阱（=1 即只拦单人抽奖）", -1))
                                      ]))
                                    : _createCommentVNode("", true)
                                ], 64))
                              : _createCommentVNode("", true)
                        ...
                        ? (_openBlock(), _createElementBlock(_Fragment, { key: 4 }, [
                            ...
                            _createElementVNode("section", _hoisted_32, [
                              _createElementVNode("label", _hoisted_33, [
                                _withDirectives(_createElementVNode("input", {
                                  "onUpdate:modelValue": _cache[20] || (_cache[20] = $event => ((cfg.lottery_wait_enabled) = $event)),
                                  type: "checkbox"
                                }, null, 512), [
                                  [_vModelCheckbox, cfg.lottery_wait_enabled]
                                ]),
                                _cache[72] || (_cache[72] = _createElementVNode("span", null, "抽奖等待时间总开关（关闭则相关动作立即执行）", -1))
                              ]),
                              (cfg.lottery_wait_enabled)
                                ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                                    _createElementVNode("div", _hoisted_34, [
                                      _createElementVNode("label", _hoisted_35, [
                                        _cache[73] || (_cache[73] = _createElementVNode("span", null, "参与前(最小)", -1)),
                                        _withDirectives(_createElementVNode("input", {
                                          "onUpdate:modelValue": _cache[21] || (_cache[21] = $event => ((cfg.lottery_participate_wait_min) = $event)),
                                          class: "inp sm",
                                          type: "number"
                                        }, null, 512), [
                                          [
                                        ...
                                        _cache[74] || (_cache[74] = _createElementVNode("span", { class: "hint" }, "秒", -1))
                                      ]),
                                      _createElementVNode("label", _hoisted_36, [
                                        _cache[75] || (_cache[75] = _createElementVNode("span", null, "参与前(最大)", -1)),
                                        _withDirectives(_createElementVNode("input", {
                                          "onUpdate:modelValue": _cache[22] || (_cache[22] = $event => ((cfg.lottery_participate_wait_max) = $event)),
                                          class: "inp sm",
                                          type: "number"
                                        }, null, 512), [
                                          [
                                      ...
                                      _createElementVNode("label", _hoisted_37, [
                                        _cache[77] || (_cache[77] = _createElementVNode("span", null, "感谢(最小)", -1)),
                                        _withDirectives(_createElementVNode("input", {
                                          "onUpdate:modelValue": _cache[23] || (_cache[23] = $event => ((cfg.lottery_thank_wait_min) = $event)),
                                          class: "inp sm",
                                          type: "number"
                                        }, null, 512), [
                                          [
                                      ...
                                      _createElementVNode("label", _hoisted_38, [
                                        _cache[79] || (_cache[79] = _createElementVNode("span", null, "感谢(最大)", -1)),
                                        _withDirectives(_createElementVNode("input", {
                                          "onUpdate:modelValue": _cache[24] || (_cache[24] = $event => ((cfg.lottery_thank_wait_max) = $event)),
                                          class: "inp sm",
                                          type: "number"
                                        }, null, 512), [
                                          [
                                      ...
                                      _createElementVNode("label", _hoisted_39, [
                                        _cache[81] || (_cache[81] = _createElementVNode("span", null, "黑幕(最小)", -1)),
                                        _withDirectives(_createElementVNode("input", {
                                          "onUpdate:modelValue": _cache[25] || (_cache[25] = $event => ((cfg.lottery_heimu_wait_min) = $event)),
                                          class: "inp sm",
                                          type: "number"
                                        }, null, 512), [
                                          [
                                      ...
                                      _createElementVNode("label", _hoisted_40, [
                                        _cache[83] || (_cache[83] = _createElementVNode("span", null, "黑幕(最大)", -1)),
                                        _withDirectives(_createElementVNode("input", {
                                          "onUpdate:modelValue": _cache[26] || (_cache[26] = $event => ((cfg.lottery_heimu_wait_max) = $event)),
                                          class: "inp sm",
                                          type: "number"
                                        }, null, 512), [
                                          [
                                      ...
                                      _createElementVNode("label", _hoisted_41, [
                                        _cache[85] || (_cache[85] = _createElementVNode("span", null, "负面(最小)", -1)),
                                        _withDirectives(_createElementVNode("input", {
                                          "onUpdate:modelValue": _cache[27] || (_cache[27] = $event => ((cfg.lottery_negative_wait_min) = $event)),
                                          class: "inp sm",
                                          type: "number"
                                        }, null, 512), [
                                          [
                                      ...
                                      _createElementVNode("label", _hoisted_42, [
                                        _cache[87] || (_cache[87] = _createElementVNode("span", null, "负面(最大)", -1)),
                                        _withDirectives(_createElementVNode("input", {
                                          "onUpdate:modelValue": _cache[28] || (_cache[28] = $event => ((cfg.lottery_negative_wait_max) = $event)),
                                          class: "inp sm",
                                          type: "number"
                                        }, null, 512), [
                                          [
                                    ...
                                    _createElementVNode("label", _hoisted_43, [
                                      _cache[89] || (_cache[89] = _createElementVNode("span", null, "按群专属等待", -1)),
                                      _withDirectives(_createElementVNode("textarea", {
                                        "onUpdate:modelValue": _cache[29] || (_cache[29] = $event => ((cfg.group_wait_overrides) = $event)),
                                        class: "inp",
                                        rows: "2",
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-4af0c26c"]]);
