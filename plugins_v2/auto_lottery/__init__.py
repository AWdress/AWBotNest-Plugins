"""auto_lottery AWBotNest V2 原生插件入口。"""
...
__plugin__ = {'name': '小菜抽奖',
 ...
 'changelog': 'v2.0.6 修复消息链接\n'
              ...
              'v2.0.5 修复多行通知显示\n'
              '- 参与和发奖结果按状态、详情拆分为独立表格行\n'
              '- 避免完整正文挤入单个单元格导致裁切或显示不全\n\n'
              'v2.0.4 修复 Telethon 实体解析与自动参与\n'
              '- 正确读取 Telethon 粗体、链接等消息实体，恢复新抽奖解析和参与\n'
              '- 修复开奖参与链接解析，并补充启动状态与跳过原因日志\n\n'
              'v2.0.3 统一富文本表格通知\n'
              '- 参与及发奖结果改为平台结构化表格\n\n'
              'v2.0.2 修复参与成功后通知异常\n'
              '- 显式传递抽奖群实体，修复后台任务引用 chat 导致 NameError\n'
              '- 参与发送与成功通知分开处理，已成功参与不再被误报为失败\n'
              '\n'
              'v2.0.1 修复消息链接与中奖记录群名\n'
