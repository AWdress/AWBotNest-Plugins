          ...
          <template v-if="group === 'account'">
            ...
            <section class="card">
              <div class="grid">
                ...
                <label class="row"><span>密码</span><div class="secret-field"><input v-model="cfg.password" class="inp" :type="passwordVisible ? 'text' : 'password'" autocomplete="current-password" /><button type="button" :aria-label="passwordVisible ? '隐藏密码' : '显示密码'" @click="passwordVisible = !passwordVisible"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/></svg></button></div></label>
