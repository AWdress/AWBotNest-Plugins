...
const _hoisted_38 = { class: "secret" };
const _hoisted_39 = ["type"];
const _hoisted_40 = ["aria-label"];
const _hoisted_41 = { class: "span2" };
const _hoisted_42 = { class: "strategy" };
...
const _hoisted_46 = { class: "section-head" };
const _hoisted_47 = {
  key: 0,
  class: "empty"
};
const _hoisted_48 = { class: "run" };
    ...
    (tab.value==='console')
      ? (_openBlock(), _createElementBlock("main", _hoisted_8, [
          _createElementVNode("section", _hoisted_9, [
            ...
            (_openBlock(), _createElementBlock(_Fragment, null, _renderList(FEATURES, (f) => {
              return _createElementVNode("button", {
                ...
                _cache[23] || (_cache[23] = _createElementVNode("i", null, null, -1)),
                ...
                _cache[24] || (_cache[24] = _createElementVNode("em", null, "›", -1))
              ], 10, _hoisted_11)
            }), 64))
          ]),
          _createElementVNode("section", _hoisted_12, [
            _createElementVNode("div", _hoisted_13, [
              _createElementVNode("div", null, [
                _cache[25] || (_cache[25] = _createElementVNode("span", { class: "kicker" }, "ACTIVE MODULE", -1)),
            ...
            _createElementVNode("div", _hoisted_15, [
              _cache[27] || (_cache[27] = _createElementVNode("span", null, "作用范围", -1)),
            ...
            (current.value.key==='genre_mapper')
              ? (_openBlock(), _createElementBlock("div", _hoisted_17, [
                  _createElementVNode("label", null, [
                    _cache[28] || (_cache[28] = _createTextVNode("Genre 映射 JSON", -1)),
                  ...
                  _createElementVNode("label", null, [
                    _cache[29] || (_cache[29] = _createTextVNode("要删除的 Genre", -1)),
                    _withDirectives(_createElementVNode("textarea", {
              ...
              : (current.value.key==='strm_mediainfo')
                ? (_openBlock(), _createElementBlock("div", _hoisted_18, [
                    _cache[30] || (_cache[30] = _createElementVNode("label", null, "STRM 请求间隔", -1)),
                ...
                : (_openBlock(), _createElementBlock("div", _hoisted_20, [
                    _cache[31] || (_cache[31] = _createElementVNode("svg", { viewBox: "0 0 24 24" }, [
            ...
            _createElementVNode("div", _hoisted_21, [
              _createElementVNode("label", _hoisted_22, [
                ...
                _cache[32] || (_cache[32] = _createElementVNode("span", null, "加入定时计划", -1))
              ]),
              _createElementVNode("div", null, [
          ...
          _createElementVNode("aside", _hoisted_26, [
            _cache[37] || (_cache[37] = _createElementVNode("span", { class: "kicker" }, "AUTOMATION", -1)),
            _cache[38] || (_cache[38] = _createElementVNode("h2", null, "维护计划", -1)),
            _createElementVNode("label", _hoisted_27, [
              _createElementVNode("span", null, [
                _cache[33] || (_cache[33] = _createElementVNode("strong", null, "定时执行", -1)),
      ...
      : (tab.value==='connection')
        ? (_openBlock(), _createElementBlock("main", _hoisted_32, [
            _cache[49] || (_cache[49] = _createElementVNode("div", { class: "settings-title" }, [
            ...
            _createElementVNode("div", _hoisted_33, [
              _createElementVNode("label", _hoisted_34, [
                _cache[39] || (_cache[39] = _createTextVNode("Emby 地址", -1)),
                _withDirectives(_createElementVNode("input", {
              ...
              _createElementVNode("label", null, [
                _cache[41] || (_cache[41] = _createTextVNode("API Key", -1)),
                _createElementVNode("div", _hoisted_35, [
                  ...
                  _createElementVNode("button", {
                    ...
                    onClick: _cache[12] || (_cache[12] = $event => (secretVisible.api_key=!secretVisible.api_key))
                  }, [...(_cache[40] || (_cache[40] = [
              ...
              _createElementVNode("label", null, [
                _cache[42] || (_cache[42] = _createTextVNode("用户 ID ", -1)),
                _withDirectives(_createElementVNode("input", {
              ...
              _createElementVNode("label", null, [
                _cache[44] || (_cache[44] = _createTextVNode("TMDB API Key", -1)),
                _createElementVNode("div", _hoisted_38, [
                  ...
                  _createElementVNode("button", {
                    ...
                    onClick: _cache[15] || (_cache[15] = $event => (secretVisible.tmdb_key=!secretVisible.tmdb_key))
                  }, [...(_cache[43] || (_cache[43] = [
                    _createElementVNode("svg", {
                      viewBox: "0 0 24 24",
                      "aria-hidden": "true"
              ...
              _createElementVNode("label", _hoisted_41, [
                _cache[45] || (_cache[45] = _createTextVNode("媒体库名称", -1)),
                _withDirectives(_createElementVNode("textarea", {
                  "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((form.library_names) = $event)),
                  rows: "5",
            ...
            _cache[50] || (_cache[50] = _createElementVNode("hr", null, null, -1)),
            _createElementVNode("div", _hoisted_42, [
              _createElementVNode("label", _hoisted_43, [
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((form.fix_lock_data) = $event)),
                  type: "checkbox"
                }, null, 512), [
                  [_vModelCheckbox, form.fix_lock_data]
                ]),
                _cache[46] || (_cache[46] = _createElementVNode("span", null, "修复后锁定条目数据", -1))
              ]),
              _createElementVNode("label", _hoisted_44, [
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((form.add_hant_title) = $event)),
                  type: "checkbox"
                }, null, 512), [
                  [_vModelCheckbox, form.add_hant_title]
                ]),
                _cache[47] || (_cache[47] = _createElementVNode("span", null, "别名包含繁中标题", -1))
              ]),
              _createElementVNode("label", null, [
                _cache[48] || (_cache[48] = _createTextVNode("输出条目上限", -1)),
                _withDirectives(_createElementVNode("input", {
                  "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((form.max_output) = $event)),
                  type: "number",
                  min: "5",
                  max: "200"
                }, null, 512), [
        ...
        : (_openBlock(), _createElementBlock("main", _hoisted_45, [
            _createElementVNode("div", _hoisted_46, [
              ...
              _createElementVNode("span", {
                ...
                _cache[51] || (_cache[51] = _createElementVNode("i", null, null, -1)),
                _createTextVNode(_toDisplayString(status.running?'运行中':'自动刷新'), 1)
              ], 2)
            ]),
            (!status.history?.length)
              ? (_openBlock(), _createElementBlock("div", _hoisted_47, "还没有维护记录。运行一次任务后，结果会留在这里。"))
              : _createCommentVNode("", true),
            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(status.history, (row) => {
              return (_openBlock(), _createElementBlock("article", _hoisted_48, [
