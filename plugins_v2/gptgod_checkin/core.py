    ...
    "config_schema": {
        ...
        "accounts": {
            ...
            "fields": {
                ...
                "password": {"type": "password", "label": "账户密码"},
            },
        },
        "email": {
...
async def setup(ctx):
    ...
    async def _api_run(request):
        return await _run_now()
    ...
    async def _api_status(request):
        return {
            ...
            "history": (await ctx.storage.get(HISTORY_KEY, []) or [])[-10:],
        }
