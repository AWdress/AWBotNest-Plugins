        ...
        <div class="detail">
          ...
          <template v-else-if="group === 'tg'">
            ...
            <section class="card">
              ...
              <label class="row"><span>Bot Token</span><div class="secret-field"><input v-model="cfg.tg_bot_token" class="inp" :type="secretVisible.tg_bot_token ? 'text' : 'password'" placeholder="@BotFather 获取，可填平台机器人 token" /><button type="button" aria-label="显示或隐藏 Bot Token" @click="secretVisible.tg_bot_token = !secretVisible.tg_bot_token"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/></svg></button></div></label>
          ...
          <template v-else-if="group === 'wx'">
            ...
            <section class="card">
              ...
              <label class="row"><span>Corp Secret</span><div class="secret-field"><input v-model="cfg.wx_corp_secret" class="inp" :type="secretVisible.wx_corp_secret ? 'text' : 'password'" /><button type="button" aria-label="显示或隐藏 Corp Secret" @click="secretVisible.wx_corp_secret = !secretVisible.wx_corp_secret"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/></svg></button></div></label>
              <div class="grid">
